/*
 CanvasJS HTML5 & JavaScript Charts - v3.4.13 GA - https://canvasjs.com/ 
...
1*n);return h}function W(h,n){var v=!1;0>h&&(v=!0,h*=-1);h=""+h;for(n=n?n:1;h.length<n;)h="0"+h;return v?"-"+h:h}function Fa(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var n=/\s/,v=h.length;n.test(h.charAt(--v)););return h.slice(0,v+1)}function Ba(h){h.roundRect=function(h,v,s,w,ra,E,y,F){y&&(this.fillStyle=y);F&&(this.strokeStyle=F);"undefined"===typeof ra&&(ra=5);this.lineWidth=E;this.beginPath();this.moveTo(h+ra,v);this.lineTo(h+s-ra,v);this.quadraticCurveTo(h+s,v,h+s,v+ra);this.lineTo(h+s,
v+w-ra);this.quadraticCurveTo(h+s,v+w,h+s-ra,v+w);this.lineTo(h+ra,v+w);this.quadraticCurveTo(h,v+w,h,v+w-ra);this.lineTo(h,v+ra);this.quadraticCurveTo(h,v,h+ra,v);this.closePath();y&&this.fill();F&&0<E&&this.stroke()}}function Pa(h,n){return h-n}function P(h){var n=((h&16711680)>>16).toString(16),v=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);n=2>n.length?"0"+n:n;v=2>v.length?"0"+v:v;h=2>h.length?"0"+h:h;return"#"+n+v+h}function db(h,n){var v=this.length>>>0,s=Number(n)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=v);s<v;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Ca(h){h.indexOf||(h.indexOf=db);return h}function eb(h){if(S.fSDec)h[ga("`eeDwdouMhrudods")](ga("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){S._fTWm&&S._fTWm(h)})}function Wa(h,n,v){v=v||"normal";var s=h+"_"+n+"_"+v,w=Xa[s];if(isNaN(w)){try{h="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
h+"; font-size:"+n+"px; font-weight:"+v+";";if(!wa){var ra=document.body;wa=document.createElement("span");wa.innerHTML="";var E=document.createTextNode("Mpgyi");wa.appendChild(E);ra.appendChild(wa)}wa.style.display="";wa.setAttribute("style",h);w=Math.round(wa.offsetHeight);wa.style.display="none"}catch(y){w=Math.ceil(1.1*n)}w=Math.max(w,n);Xa[s]=w}return w}function N(h,n){var v=[];if(v={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<v.length;s++)v[s]*=n;else v=[];return v}function J(h,n,v,w,qa){w=w||[];qa=s(qa)?fb?{passive:!1,capture:!1}:!1:qa;w.push([h,n,v,qa]);return h.addEventListener?(h.addEventListener(n,v,qa),v):h.attachEvent?(w=function(n){n=n||window.event;n.preventDefault=n.preventDefault||function(){n.returnValue=!1};n.stopPropagation=n.stopPropagation||function(){n.cancelBubble=!0};v.call(h,n)},h.attachEvent("on"+
n,w),w):!1}function gb(h){if(h._menuButton)h.exportEnabled?(ha(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),Ka(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):ua(h._menuButton);else if(h.exportEnabled&&w){var n=!1;h._menuButton=document.createElement("button");va(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);J(h._menuButton,"touchstart",function(h){n=!0},h.allDOMEventHandlers);J(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||
h._dropDownCloseTime&&500>=(new Date).getTime()-h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);J(h._menuButton,"mousemove",function(){n||(ha(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&ha(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);J(h._menuButton,
"mouseout",function(){n||(ha(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&ha(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){ha(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var v=h._dropdownMenu.childNodes,s=[h._cultureInfo.printText,h._cultureInfo.saveJPGText,h._cultureInfo.savePNGText],
...
h.toolbar.itemBackgroundColor+";box-shadow: 2px 2px 10px "+v,h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),J(h._dropdownMenu,"blur",function(){ua(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),v=document.createElement("div"),v.style.cssText="padding: 12px 8px 12px 8px",v.innerHTML=h._cultureInfo.printText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),J(v,"touchstart",
function(h){n=!0},h.allDOMEventHandlers),J(v,"mousemove",function(){n||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(v,"mouseout",function(){n||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),J(v,"click",function(){h.print();ua(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),v.style.cssText="padding: 12px 8px 12px 8px",
...
h.allDOMEventHandlers,!0),J(v,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});ua(h._dropdownMenu)},h.allDOMEventHandlers,!0),v=document.createElement("div"),v.style.cssText="padding: 12px 8px 12px 8px",v.innerHTML=h._cultureInfo.savePNGText,v.style.backgroundColor=h.toolbar.itemBackgroundColor,v.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(v),J(v,"touchstart",function(h){n=!0},h.allDOMEventHandlers),J(v,"mousemove",function(){n||(this.style.backgroundColor=
h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),J(v,"mouseout",function(){n||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),J(v,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});ua(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Ya(h,n,v){h*=ka;n*=ka;h=v.getImageData(h,n,2,2).data;n=!0;for(v=0;4>v;v++)if(h[v]!==h[v+4]|h[v]!==h[v+8]|
...
typeof w&&(w=0);this._padding=w;this._x1=h;this._y1=n;this._x2=v;this._y2=s;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ia(h,n){ia.base.constructor.call(this,"TextBlock",null,n,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Sa(h,n){Sa.base.constructor.call(this,"Toolbar","toolbar",n,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function ya(h,n){ya.base.constructor.call(this,
...
[]}function Ia(h){var n;h&&Ja[h]&&(n=Ja[h]);Ia.base.constructor.call(this,"CultureInfo",null,n,null,null)}var Ga=!1,S={},w=!!document.createElement("canvas").getContext,pa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
H,Z,T,da,X;Z="#333333";T="#000000";H="#666666";X=da="#000000";var ca=20,F=14,Ua={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Ea,fontSize:32,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:F,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:Z,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:Z,
titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,
labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,
labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],legend:{fontFamily:y,fontSize:14,fontColor:Z,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};T=Z="#F5F5F5";H="#FFFFFF";da="#40BAF1";X="#F5F5F5";var ca=20,F=14,$a={colorSet:"colorSet2",title:{fontFamily:y,
fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:F,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:y,indexLabelFontSize:F,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",
...
lineDashType:"solid"}}],axisX2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:"#666666",titleFontWeight:"normal",
labelFontFamily:y,labelFontSize:F,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},
...
da="#40BAF1";X="#F5F5F5";ca=20;F=14;Ea={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Ea,fontSize:32,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Ea,fontSize:F,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,indexLabelFontSize:F,
indexLabelFontColor:T,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,
labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,
labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:Z,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:T,backgroundColor:"rgba(0, 0, 0, .7)"}};H="#FFFFFF";T=Z="#FAFAFA";da="#40BAF1";X="#F5F5F5";
var ca=20,F=14,ab={light1:Ua,light2:$a,dark1:Ea,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:y,fontSize:32,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:y,fontSize:F,fontColor:Z,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:y,
indexLabelFontSize:F,indexLabelFontColor:T,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,
labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:1,lineColor:H,tickThickness:1,tickColor:H,gridThickness:0,gridColor:H,stripLines:[{labelFontFamily:y,
labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,
labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",
lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:y,titleFontSize:ca,titleFontColor:T,titleFontWeight:"normal",labelFontFamily:y,labelFontSize:F,labelFontColor:T,labelFontWeight:"normal",lineThickness:0,lineColor:H,tickThickness:1,tickColor:H,gridThickness:1,gridColor:H,stripLines:[{labelFontFamily:y,labelFontSize:F,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:y,labelFontSize:F,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:X,color:da,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:y,fontSize:14,fontColor:Z,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:y,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:T,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Ua,theme2:$a,theme3:Ua},R={numberDuration:1,
...
S.pos[n]&&(h[S.fSDec("^bsdehuMhoj")].style.right=S.fSDec("`tun"))}catch(y){}}})();var fb=function(){var h=!1;try{var n=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,n),window.removeEventListener("test",null,n))}catch(v){h=!1}return h}(),Xa={},wa=null,kb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,
0,this.width,this.height))},lb=function(h,n,v){n=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=n?12:11,Math.round(n*(h/400)))},Aa=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,n="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),v="Sun Mon Tue Wed Thu Fri Sat".split(" "),s="January February March April May June July August September October November December".split(" "),w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),
y=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,E=/[^-+\dA-Z]/g;return function(F,N,M){var H=M?M.days:n,P=M?M.months:s,J=M?M.shortDays:v,R=M?M.shortMonths:w;M="";var S=!1;F=F&&F.getTime?F:F?new Date(F):new Date;if(isNaN(F))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),S=!0);M=S?"getUTC":"get";var U=F[M+"Date"](),K=F[M+"Day"](),V=F[M+"Month"](),a=F[M+"FullYear"](),d=F[M+"Hours"](),c=F[M+
"Minutes"](),b=F[M+"Seconds"](),e=F[M+"Milliseconds"](),f=S?0:F.getTimezoneOffset();return M=N.replace(h,function(l){switch(l){case "D":return U;case "DD":return W(U,2);case "DDD":return J[K];case "DDDD":return H[K];case "M":return V+1;case "MM":return W(V+1,2);case "MMM":return R[V];case "MMMM":return P[V];case "Y":return parseInt(String(a).slice(-2));case "YY":return W(String(a).slice(-2),2);case "YYY":return W(String(a).slice(-3),3);case "YYYY":return W(a,4);case "h":return d%12||12;case "hh":return W(d%
12||12,2);case "H":return d;case "HH":return W(d,2);case "m":return c;case "mm":return W(c,2);case "s":return b;case "ss":return W(b,2);case "f":return W(String(e),3).slice(0,1);case "ff":return W(String(e),3).slice(0,2);case "fff":return W(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return S?"UTC":(String(F).match(y)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/
60);case "zz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+W(Math.floor(Math.abs(f)/60),2)+W(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(h,n,v){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var s=0>h?!0:!1;s&&(h*=-1);var w=v?v.decimalSeparator:".",y=v?v.digitGroupSeparator:",",E="";n=String(n);var E=1,F=v="",N=-1,M=[],H=[],P=0,J=0,R=0,S=!1,U=0,F=n.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);n=null;for(var K=
0;F&&K<F.length;K++)if(n=F[K],"."===n&&0>N)N=K;else{if("%"===n)E*=100;else if("\u2030"===n){E*=1E3;continue}else if(","===n[0]&&"."===n[n.length-1]){E/=Math.pow(1E3,n.length-1);N=K+n.length-1;continue}else"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-1]||(S=!0);0>N?(M.push(n),"#"===n||"0"===n?P++:","===n&&R++):(H.push(n),"#"!==n&&"0"!==n||J++)}S&&(n=Math.floor(h),F=-Math.floor(Math.log(h)/Math.LN10+1),U=0===h?0:0===n?-(P+F):String(n).length-P,E/=Math.pow(10,U));0>N&&(N=K);E=(h*E).toFixed(J);n=E.split(".");
E=(n[0]+"").split("");h=(n[1]+"").split("");E&&"0"===E[0]&&E.shift();for(S=F=K=J=N=0;0<M.length;)if(n=M.pop(),"#"===n||"0"===n)if(N++,N===P){var V=E,E=[];if("0"===n)for(n=P-J-(V?V.length:0);0<n;)V.unshift("0"),n--;for(;0<V.length;)v=V.pop()+v,S++,0===S%F&&(K===R&&0<V.length)&&(v=y+v)}else 0<E.length?(v=E.pop()+v,J++,S++):"0"===n&&(v="0"+v,J++,S++),0===S%F&&(K===R&&0<E.length)&&(v=y+v);else"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-1]||!/[eE][+-]*[0]+/.test(n)?","===n?(K++,F=S,S=0,0<E.length&&(v=y+v)):
v=1<n.length&&('"'===n[0]&&'"'===n[n.length-1]||"'"===n[0]&&"'"===n[n.length-1])?n.slice(1,n.length-1)+v:n+v:(n=0>U?n.replace("+","").replace("-",""):n.replace("-",""),v+=n.replace(/[0]+/,function(a){return W(U,a.length)}));y="";for(M=!1;0<H.length;)n=H.shift(),"#"===n||"0"===n?0<h.length&&0!==Number(h.join(""))?(y+=h.shift(),M=!0):"0"===n&&(y+="0",M=!0):1<n.length&&('"'===n[0]&&'"'===n[n.length-1]||"'"===n[0]&&"'"===n[n.length-1])?y+=n.slice(1,n.length-1):"E"!==n[0]&&"e"!==n[0]||"0"!==n[n.length-
1]||!/[eE][+-]*[0]+/.test(n)?y+=n:(n=0>U?n.replace("+","").replace("-",""):n.replace("-",""),y+=n.replace(/[0]+/,function(a){return W(U,a.length)}));v+=(M?w:"")+y;return s?"-"+v:v},Na=function(h){var n=0,v=0;h=h||window.event;h.offsetX||0===h.offsetX?(n=h.offsetX,v=h.offsetY):h.layerX||0==h.layerX?(n=h.layerX,v=h.layerY):(n=h.pageX-h.target.offsetLeft,v=h.pageY-h.target.offsetTop);return{x:n,y:v}},Za=!0,Qa=window.devicePixelRatio||1,Ma=1,ka=Za?Qa/Ma:1,$=function(h,n,v,s,w,y,E,F,N,M,P,S,H){"undefined"===
typeof H&&(H=1);E=E||0;F=F||"black";var J=15<s-n&&15<w-v?8:0.35*Math.min(s-n,w-v);h.beginPath();h.moveTo(n,v);h.save();h.fillStyle=y;h.globalAlpha=H;h.fillRect(n,v,s-n,w-v);h.globalAlpha=1;0<E&&(H=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=F,h.moveTo(n,v),h.rect(n-H,v-H,s-n+2*H,w-v+2*H),h.stroke());h.restore();!0===N&&(h.save(),h.beginPath(),h.moveTo(n,v),h.lineTo(n+J,v+J),h.lineTo(s-J,v+J),h.lineTo(s,v),h.closePath(),E=h.createLinearGradient((s+n)/2,v+J,(s+n)/2,v),E.addColorStop(0,y),
E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===M&&(h.save(),h.beginPath(),h.moveTo(n,w),h.lineTo(n+J,w-J),h.lineTo(s-J,w-J),h.lineTo(s,w),h.closePath(),E=h.createLinearGradient((s+n)/2,w-J,(s+n)/2,w),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(n,v),h.lineTo(n+J,v+J),h.lineTo(n+J,w-J),h.lineTo(n,w),h.closePath(),E=h.createLinearGradient(n+J,(w+v)/2,n,(w+v)/2),E.addColorStop(0,
y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===S&&(h.save(),h.beginPath(),h.moveTo(s,v),h.lineTo(s-J,v+J),h.lineTo(s-J,w-J),h.lineTo(s,w),E=h.createLinearGradient(s-J,(w+v)/2,s,(w+v)/2),E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,E.addColorStop(0,y),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},ga=function(h){for(var n="",s=0;s<h.length;s++)n+=String.fromCharCode(Math.ceil(h.length/
57/5)^h.charCodeAt(s));return n},bb=window&&window[ga("mnb`uhno")]&&window[ga("mnb`uhno")].href&&window[ga("mnb`uhno")].href.indexOf&&(-1!==window[ga("mnb`uhno")].href.indexOf(ga("b`ow`rkr/bnl"))||-1!==window[ga("mnb`uhno")].href.indexOf(ga("gdonqhy/bnl"))||-1!==window[ga("mnb`uhno")].href.indexOf(ga("gheemd"))),ib=bb&&-1===window[ga("mnb`uhno")].href.indexOf(ga("gheemd")),jb={reset:{image:"data:image/png;base64,"},
...
U.prototype.setOptions=function(h,n){if(pa[this._defaultsKey]){var s=pa[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:n&&w in n?n[w]:s[w])}else Ga&&window.console&&console.log("defaults not set")};U.prototype.get=function(h){var n=pa[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(n.hasOwnProperty(h)||n.publicProperties&&n.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};U.prototype.set=function(h,n,s){s="undefined"===typeof s?!0:s;var w=pa[this._defaultsKey];if("options"===h)this.createUserOptions(n);else if(w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=n;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?
window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}s&&(this.stockChart||this.chart||this).render()};U.prototype.addTo=function(h,n,s,w){w="undefined"===typeof w?!0:w;var y=pa[this._defaultsKey];y.hasOwnProperty(h)||y.publicProperties&&y.publicProperties.hasOwnProperty(h)&&"readWrite"===y.publicProperties[h]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[h]&&(this.options[h]=
[]),h=this.options[h],s="undefined"===typeof s||null===s?h.length:s,h.splice(s,0,n),w&&(this.stockChart||this.chart||this).render()):window.console&&(y.publicProperties&&y.publicProperties.hasOwnProperty(h)&&"readOnly"===y.publicProperties[h]?window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."))};U.prototype.createUserOptions=function(h){if("undefined"!==typeof h||this.options._isPlaceholder)if(this.parent.options._isPlaceholder&&
this.parent.createUserOptions(),this.isOptionsInArray){this.parent.options[this.optionsName]||(this.parent.options[this.optionsName]=[]);var n=this.parent.options[this.optionsName],s=n.length;this.options._isPlaceholder||(Ca(n),s=n.indexOf(this.options));this.options="undefined"===typeof h?{}:h;n[s]=this.options}else this.options="undefined"===typeof h?{}:h,h=this.parent.options,this.optionsName?n=this.optionsName:(n=this._defaultsKey)&&0!==n.length?(s=n.charAt(0).toLowerCase(),1<n.length&&(s=s.concat(n.slice(1))),
n=s):n=void 0,h[n]=this.options};U.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var n=this.parent.options[this.optionsName];Ca(n);var s=n.indexOf(this.options);0<=s&&n.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};U.prototype.updateOption=function(h){!pa[this._defaultsKey]&&(Ga&&window.console)&&console.log("defaults not set");var n=pa[this._defaultsKey],w={},y=this[h],F=this._themeOptionsKey,
J=this._index;this.theme&&s(this.parent)&&s(F)&&s(J)?w=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[F])&&(null===J?w=this.parent.themeOptions[F]:0<this.parent.themeOptions[F].length&&(w=Math.min(this.parent.themeOptions[F].length-1,J),w=this.parent.themeOptions[F][w]));this.themeOptions=w;h in n&&(y=h in this.options?this.options[h]:w&&h in w?w[h]:n[h]);if(y===this[h])return!1;this[h]=
y;return!0};U.prototype.trackChanges=function(h){if(!this.sessionVariables)throw"Session Variable Store not set";this.sessionVariables[h]=this.options[h]};U.prototype.isBeingTracked=function(h){this.options._oldOptions||(this.options._oldOptions={});return this.options._oldOptions[h]?!0:!1};U.prototype.hasOptionChanged=function(h){if(!this.sessionVariables)throw"Session Variable Store not set";return this.sessionVariables[h]!==this.options[h]};U.prototype.addEventListener=function(h,n,s){h&&n&&(this._eventListeners[h]=
this._eventListeners[h]||[],this._eventListeners[h].push({context:s||this,eventHandler:n}))};U.prototype.removeEventListener=function(h,n){if(h&&n&&this._eventListeners[h])for(var s=this._eventListeners[h],w=0;w<s.length;w++)if(s[w].eventHandler===n){s[w].splice(w,1);break}};U.prototype.removeAllEventListeners=function(){this._eventListeners=[]};U.prototype.dispatchEvent=function(h,n,s){if(h&&this._eventListeners[h]){n=n||{};for(var w=this._eventListeners[h],y=0;y<w.length;y++)w[y].eventHandler.call(w[y].context,
n)}"function"===typeof this[h]&&this[h].call(s||this.chart,n)};Da.prototype.registerSpace=function(h,n){"top"===h?this._topOccupied+=n.height:"bottom"===h?this._bottomOccupied+=n.height:"left"===h?this._leftOccupied+=n.width:"right"===h&&(this._rightOccupied+=n.width)};Da.prototype.unRegisterSpace=function(h,n){"top"===h?this._topOccupied-=n.height:"bottom"===h?this._bottomOccupied-=n.height:"left"===h?this._leftOccupied-=n.width:"right"===h&&(this._rightOccupied-=n.width)};Da.prototype.getFreeSpace=
...
this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-F.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-F.width/2+this.leftPadding;this.ctx.fillText(F.text,w,y);y+=F.height}this.ctx.font=n;h&&this.ctx.restore()}};ia.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ia.prototype.measureText=function(){this._lineHeight=Wa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ia.prototype._getLineWithWidth=function(h,n,s){h=String(h);if(!h)return{text:"",width:0};var w=s=0,y=h.length-1,F=Infinity;for(this.ctx.font=this._getFontString();w<=y;){var F=Math.floor((w+y)/2),E=h.substr(0,F+1);s=this.ctx.measureText(E).width;
if(s<n)w=F+1;else if(s>n)y=F-1;else break}s>n&&1<E.length&&(E=E.substr(0,E.length-1),s=this.ctx.measureText(E).width);n=!0;if(E.length===h.length||" "===h[E.length])n=!1;n&&(h=E.split(" "),1<h.length&&h.pop(),E=h.join(" "),s=this.ctx.measureText(E).width);return{text:E,width:s}};ia.prototype._wrapText=function(){var h=new String(Fa(String(this.text))),n=[],s=this.ctx.font,w=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=w=0;else for(;0<h.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),E=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;n.push(E);var J=y,y=Math.max(y,E.width),w=w+E.height,h=Fa(h.slice(E.text.length,h.length));F&&w>F&&(E=n.pop(),w-=E.height,y=J)}this._wrappedText={lines:n,width:y,height:w};this.width=y+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=s};ia.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var n=this.fontFamily?this.fontFamily+"":"";!w&&n&&(n=n.split(",")[0],"'"!==n[0]&&'"'!==n[0]&&(n="'"+n+"'"));return h+=n};oa(Sa,U);oa(ya,U);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,n=h.layoutManager.getFreeSpace(),w=n.x1,y=n.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,H;"top"===this.verticalAlign||
...
backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:J,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});M=J.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(y=n.y1+2,H="top"):"bottom"===this.verticalAlign&&(y=n.y2-2-M.height,H="bottom"),"left"===this.horizontalAlign?w=n.x1+2:"center"===this.horizontalAlign?w=n.x1+n.width/2-M.width/2:"right"===this.horizontalAlign&&(w=n.x2-2-M.width-E),N=this.horizontalAlign,
this.width=M.width,this.height=M.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(w=n.x1+2,y=n.y2-2-(this.maxWidth/2-M.width/2),F=-90,H="left",this.width=M.height,this.height=M.width):"right"===this.horizontalAlign?(w=n.x2-2,y=n.y1+2+(this.maxWidth/2-M.width/2),F=90,H="right",this.width=M.height,this.height=M.width):"center"===this.horizontalAlign&&(y=h.y1+(h.height/2-M.height/2),w=h.x1+(h.width/2-M.width/2),H="center",this.width=M.width,this.height=M.height),N="center");J.x=
w;J.y=y;J.angle=F;J.horizontalAlign=N;this._textBlock=J;h.layoutManager.registerSpace(H,{width:this.width+("left"===H||"right"===H?this.margin+2:0),height:this.height+("top"===H||"bottom"===H?this.margin+2:0)});this.bounds={x1:w,y1:y,x2:w+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};oa(Ha,U);Ha.prototype.setLayout=ya.prototype.setLayout;Ha.prototype.render=ya.prototype.render;Ta.prototype.get=function(h,n){var w=
null;0<this.pool.length?(w=this.pool.pop(),La(w,h,n)):w=ta(h,n);return w};Ta.prototype.release=function(h){this.pool.push(h)};oa(Ia,U);var Oa={addTheme:function(h,n){ab[h]=n},addColorSet:function(h,n){za[h]=n},addCultureInfo:function(h,n){Ja[h]=n},formatNumber:function(h,n,w){w=w||"en";if(Ja[w])return ea(h,n||"#,##0.##",new Ia(w));throw"Unknown Culture Name";},formatDate:function(h,n,w){w=w||"en";if(Ja[w])return Aa(h,n||"DD MMM YYYY",new Ia(w));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
"undefined"!==typeof module.exports?module.exports=Oa:"function"===typeof define&&define.amd?define([],function(){return Oa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Oa);y=Oa.Chart=function(){function h(a,d){return a.x-d.x}function n(a,d,c){d=d||{};s(c)?(this.predefinedThemes=ab,this.optionsName=
...
2+1;var B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x+B/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<B||a[t].x<a[f].x&&0>B?{x:a[t].x-B/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function y(a,d,c,b,e,f,l,t,B,k){var m=0;k?(l.color=f,t.color=f):
...
this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new M(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new Z(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=void 0,this.sessionVariables.viewportMinimum=
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function Z(a,d,c){Z.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function W(a,d){W.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
...
this.layoutManager=new Da(0,0,this.width,this.height,this.isNavigator?0:2);this.plotArea.layoutManager&&this.plotArea.layoutManager.reset();this.data=[];this.title=null;this.subtitles=[];var a=0,d=null;if(this.options.data){for(var c=0;c<this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=n._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new H(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?
...
d||"normal",this.data[c]._linkedSeries=null===this.data[c].linkedDataSeriesIndex?null:this.data[this.data[c].linkedDataSeriesIndex])}}this._objectsInitialized=!0;this._plotAreaElements=[]};n._supportedChartTypes=Ca("line stepLine spline column area stepArea splineArea bar bubble scatter stackedColumn stackedColumn100 stackedBar stackedBar100 stackedArea stackedArea100 candlestick ohlc boxAndWhisker rangeColumn error rangeBar rangeArea rangeSplineArea pie doughnut funnel pyramid waterfall".split(" "));
...
b/t.dataPoints[B-1].x;1>r&&(r=1/r);c.minDiff>r&&1!==r&&(c.minDiff=r)}else r=b-t.dataPoints[B-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r);null!==e&&null!==t.dataPoints[B-1].y&&(a.axisY.logarithmic?(r=e/t.dataPoints[B-1].y,1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e-t.dataPoints[B-1].y,0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!m)m=!0;else if(b>g&&m)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);
...
b/p.dataPoints[q-1].x;1>x&&(x=1/x);c.minDiff>x&&1!==x&&(c.minDiff=x)}else x=b-p.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/p.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-p.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<n&&!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>u&&!r)r=!0;else if(b>u&&r)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=
p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,B=Math.min(e,B)):t[b]?t[b]+=e:(t[b]=e,k=Math.max(e,k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,
l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,t)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=t));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,B)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,B)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in t)t.hasOwnProperty(q)&&!isNaN(q)&&(a=t[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,k)),q<
...
m.dataPoints[p].x.getTime||"dateTime"===m.xValueType)f=!0;for(p=0;p<m.dataPoints.length;p++){"undefined"===typeof m.dataPoints[p].x&&(m.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));m.dataPoints[p].x.getTime?(f=!0,b=m.dataPoints[p].x.getTime()):b=m.dataPoints[p].x;e=s(m.dataPoints[p].y)?null:m.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var u=b/m.dataPoints[p-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-m.dataPoints[p-1].x,0>u&&(u*=-1),c.minDiff>
u&&0!==u&&(c.minDiff=u);s(e)||null===m.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(u=e/m.dataPoints[p-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-m.dataPoints[p-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<h&&!q)null!==e&&(r=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>n&&!g)g=!0;else if(b>n&&g)continue;m.dataPoints[p].label&&(a.axisX.labels[b]=m.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&r<
b&&(c.viewPortMin=r):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}m.axisX.valueType=m.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=s(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=s(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!t?(d.max=s(d.viewPortMax)?99:Math.max(d.viewPortMax,
...
if((e=k.dataPoints[m].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var x=0;x<e.length;x++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<m&&(a.axisX.logarithmic?(r=b/k.dataPoints[m-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[m-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[m-1].y&&null!==k.dataPoints[m-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/
k.dataPoints[m-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[m-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<n)||p){if(!p&&(p=!0,0<m)){m-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[m].label&&(a.axisX.labels[b]=k.dataPoints[m].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&
...
p,t.dataPointEOs[B].cumulativeSum=0===B?0:t.dataPointEOs[B-1].cumulativeSum,t.dataPoints[B].y=0===B?0:b,p=0===B?0:t.dataPointEOs[B-1].cumulativeSum,b=0):(e="number"!==typeof t.dataPoints[B].y?0:t.dataPoints[B].y,t.dataPointEOs[B].cumulativeSumYStartValue=0===B?0:t.dataPointEOs[B-1].cumulativeSum,t.dataPointEOs[B].cumulativeSum=0===B?e:t.dataPointEOs[B-1].cumulativeSum+e,b+=e);for(B=0;B<t.dataPoints.length;B++)if("undefined"===typeof t.dataPoints[B].x&&(t.dataPoints[B].x=B+(a.axisX.logarithmic?1:0)),
t.dataPoints[B].x.getTime?(f=!0,b=t.dataPoints[B].x.getTime()):b=t.dataPoints[B].x,e=t.dataPoints[B].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),t.dataPointEOs[B].cumulativeSum<d.min&&(d.min=t.dataPointEOs[B].cumulativeSum),t.dataPointEOs[B].cumulativeSum>d.max&&(d.max=t.dataPointEOs[B].cumulativeSum),0<B&&(a.axisX.logarithmic?(p=b/t.dataPoints[B-1].x,1>p&&(p=1/p),c.minDiff>p&&1!==p&&(c.minDiff=p)):(p=b-t.dataPoints[B-1].x,0>p&&(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==t.dataPoints[B-
1].y&&(a.axisY.logarithmic?(e=t.dataPointEOs[B].cumulativeSum/t.dataPointEOs[B-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[B].cumulativeSum-t.dataPointEOs[B-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!m)m=!0;else if(b>g&&m)continue;t.dataPoints[B].label&&(a.axisX.labels[b]=t.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<B&&(t.dataPointEOs[B-
...
this.stockChart._rangeEventParameter,this.stockChart)),this.render(),this._dispatchRangeEvent("rangeChanged","zoom"),this.stockChart&&(this.stockChart.navigator&&this.stockChart.navigator.enabled)&&(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ka(this._zoomButton,this._resetButton),va(this,this._zoomButton,"pan"),va(this,this._resetButton,
...
g=la("indexLabelWrap",m.dataPoint,m.dataSeries);var n=la("indexLabelLineDashType",m.dataPoint,m.dataSeries),u=la("indexLabelLineColor",m.dataPoint,m.dataSeries),x=s(m.dataPoint.indexLabelLineThickness)?s(m.dataSeries.options.indexLabelLineThickness)?0:m.dataSeries.options.indexLabelLineThickness:m.dataPoint.indexLabelLineThickness,b=0<x?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,A={percent:null,total:null},C=null;if(0<=m.dataSeries.type.indexOf("stacked")||
...
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))A="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===A&&(A="inside");else if("bubble"===p||"scatter"===p)A="inside";q=m.point.x-("horizontal"===C?B/2:B/2-r/2);"inside"!==A?(e=c.y1,f=c.y2,0<v?(g=m.point.y+("horizontal"===C?r/2:0)-k-t-b,g<e&&(g="auto"===A?Math.max(m.point.y,e)+r/2+t:e+r/2+t,y=g+k>m.point.y)):(g=m.point.y+r/2+t+b,g>f-k&&(g="auto"===A?Math.min(m.point.y,f)+r/2-k-t:f+r/2-k,y=g<m.point.y))):(e=Math.max(m.bounds.y1,
...
0<=p.indexOf("scatter")?(A="auto",l=4):0<=p.indexOf("stacked")?"auto"===A&&(A="inside"):"bubble"===p&&(A="inside"),g=m.point.y+r/2-k/2+t,"inside"!==A?(e=c.x1,f=c.x2,0>v?(q=m.point.x-("horizontal"===C?B:B-r/2)-l-b,q<e&&(q="auto"===A?Math.max(m.point.x,e)+l:e+l,y=q+B>m.point.x)):(q=m.point.x+("horizontal"===C?0:r/2)+l+b,q>f-B-l-b&&(q="auto"===A?Math.min(m.point.x,f)-("horizontal"===C?B:B/2)-l:f-B-l,y=q<m.point.x))):(e=Math.max(m.bounds.x1,c.x1),Math.min(m.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===
p?0>v?Math.max(m.bounds.x1,c.x1)+r/2+l:Math.min(m.bounds.x2,c.x2)-B/2-l+("horizontal"===C?0:r/2):(Math.max(m.bounds.x1,c.x1)+Math.min(m.bounds.x2,c.x2))/2+("horizontal"===C?0:r/2),q=0>v?Math.max(m.point.x,b)-("horizontal"===C?B/2:0):Math.min(m.point.x,b)-B/2,q=Math.max(q,e));"vertical"===C&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);x&&("inside"!==A&&(0>p.indexOf("bar")&&("error"!==p||!m.axisSwapped)&&m.point.x>c.x1&&m.point.x<c.x2||!y)&&(0>p.indexOf("column")&&("error"!==p||m.axisSwapped)&&m.point.y>c.y1&&
m.point.y<c.y2||!y))&&(d.lineWidth=x,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(N(n,x)),d.beginPath(),d.moveTo(m.point.x,m.point.y),0<=p.indexOf("bar")||"error"===p&&m.axisSwapped?d.lineTo(q+(0<m.direction?-l:B+l)+("vertical"===C?-r/2:0),g+("vertical"===C?-k/2:k/2-r/2)-t):0<=p.indexOf("column")||"error"===p&&!m.axisSwapped?d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===C?(g-k<m.point.y?0:-k)+t:(g-r/2<m.point.y?k:0)-r/2)):d.lineTo(q+B/2-("horizontal"===C?0:r/2),g+("vertical"===
...
dataSeriesIndex:B};r=P(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var n=!0,u=0,x,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(x=m[u].x.getTime?m[u].x.getTime():m[u].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<u&&!(k.connectNullData||C||n)&&(c.stroke(),w&&b.stroke()),C=
!0;else{x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(m[u].y);var D=k.dataPointIds[u];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:x,y1:s};n||C?(!n&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,s),w&&b.lineTo(x,s)):(c.beginPath(),c.moveTo(x,s),w&&(b.beginPath(),
b.moveTo(x,s))),C=n=!1):(c.lineTo(x,s),w&&b.lineTo(x,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),w&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};u<m.length-1&&(h!==(m[u].lineColor||r)||p!==(m[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=m[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<m[u].markerSize||0<k.markerSize){var z=k.getMarkerProperties(u,
x,s,c);f.push(z);D=P(D);w&&f.push({x:x,y:s,ctx:b,type:z.type,size:z.size,color:D,borderColor:D,borderThickness:z.borderThickness})}(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:m[u],dataSeries:k,point:{x:x,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}V.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:B};r=P(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var n=!0,u=0,x,s;c.beginPath();if(0<m.length){for(var C=!1,u=0;u<m.length;u++)if(x=m[u].getTime?m[u].x.getTime():m[u].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!C)))if("number"!==typeof m[u].y)0<
u&&!(k.connectNullData||C||n)&&(c.stroke(),w&&b.stroke()),C=!0;else{var D=s;x=a.axisX.convertValueToPixel(x);s=a.axisY.convertValueToPixel(m[u].y);var z=k.dataPointIds[u];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:u,x1:x,y1:s};n||C?(!n&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(x,D),c.lineTo(x,s),w&&(b.lineTo(x,D),b.lineTo(x,s))):(c.beginPath(),c.moveTo(x,s),w&&(b.beginPath(),b.moveTo(x,s))),C=n=!1):(c.lineTo(x,D),w&&b.lineTo(x,D),c.lineTo(x,s),w&&b.lineTo(x,s),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(x,s),w&&(b.stroke(),b.beginPath(),b.moveTo(x,s))));l={x:x,y:s};u<m.length-1&&(h!==(m[u].lineColor||r)||p!==(m[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,s),h=m[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(m[u].lineDashType?(p=m[u].lineDashType,
c.setLineDash(N(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<m[u].markerSize||0<k.markerSize)D=k.getMarkerProperties(u,x,s,c),f.push(D),z=P(z),w&&f.push({x:x,y:s,ctx:b,type:D.type,size:D.size,color:z,borderColor:z,borderThickness:D.borderThickness});(m[u].indexLabel||k.indexLabel||m[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:m[u],dataSeries:k,point:{x:x,y:s},direction:0>m[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var n=0,u,x,s=[];b.beginPath();if(0<m.length)for(x=!1,n=0;n<m.length;n++)if(u=m[n].getTime?m[n].x.getTime():m[n].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!x)))if("number"!==typeof m[n].y)0<n&&!x&&(k.connectNullData?b.setLineDash&&(0<s.length&&(k.options.nullDataLineDashType||!m[n-1].lineDashType))&&(s[s.length-1].newLineDashArray=q,p=k.nullDataLineDashType):
(d(s),s=[])),x=!0;else{u=a.axisX.convertValueToPixel(u);x=a.axisY.convertValueToPixel(m[n].y);var C=k.dataPointIds[n];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:n,x1:u,y1:x};s[s.length]={x:u,y:x};n<m.length-1&&(h!==(m[n].lineColor||r)||p!==(m[n].lineDashType||k.lineDashType))&&(h=m[n].lineColor||r,s[s.length-1].newStrokeStyle=h,b.setLineDash&&(m[n].lineDashType?(p=m[n].lineDashType,s[s.length-1].newLineDashArray=N(p,k.lineThickness)):(p=k.lineDashType,
s[s.length-1].newLineDashArray=g)));if(0<m[n].markerSize||0<k.markerSize){var D=k.getMarkerProperties(n,u,x,b);l.push(D);C=P(C);w&&l.push({x:u,y:x,ctx:e,type:D.type,size:D.size,color:C,borderColor:C,borderThickness:D.borderThickness})}(m[n].indexLabel||k.indexLabel||m[n].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:m[n],dataSeries:k,point:{x:u,y:x},direction:0>m[n].y===a.axisY.reversed?1:-1,color:r});x=!1}d(s)}V.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,
...
B=r[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(B);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var n=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];$(c,l,t,n,u,b,0,null,h&&0<=r[f].y,
0>r[f].y&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:n,y2:u};b=P(b);w&&$(this._eventManager.ghostCtx,l,t,n,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],dataSeries:g,point:{x:l+(n-l)/2,y:0>r[f].y===a.axisY.reversed?t:u},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,
...
n=this.data[h],u=n.dataPoints;if(0<u.length){var x=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);var s=m-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(p=a.axisY.convertValueToPixel(t[b]),
D="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),D=a.axisY.convertValueToPixel(B[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=D;else if(p=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var z="undefined"!==typeof f[b]?f[b]:0;p-=z;D=q-z;f[b]=z+(D-p)}else z=l[b]?l[b]:0,D=p+z,p=q+z,l[b]=z+(D-p);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];$(c,s,p,C,D,b,0,null,x&&0<=u[k].y,0>u[k].y&&x,!1,
!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:C,y2:D};b=P(b);w&&$(this._eventManager.ghostCtx,s,p,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:u[k],dataSeries:n,point:{x:m,y:0<=u[k].y?p:D},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:C,y2:Math.max(p,
...
this.dataPointWidth:Infinity,m));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&m<k)&&(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));g<k&&(g=k);g>m&&(g=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],
n=this.data[h],u=n.dataPoints;if(0<u.length)for(var x=5<g&&n.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){m=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var s=m-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=p+
...
l[b]:0,D=p+z,p=q+z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.y2-D)&&(D=e.y2),l[b]=z+(D-p);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];$(c,s,p,C,D,b,0,null,x&&0<=u[k].y,0>u[k].y&&x,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:s,y1:p,x2:C,y2:D};b=P(b);w&&$(this._eventManager.ghostCtx,s,p,C,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&
this._indexLabels.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:n,point:{x:m,y:0<=u[k].y?p:D},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(p,D),x2:C,y2:Math.max(p,D)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
l=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+m)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+m)*p<<0;var n=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];$(c,u,t,l,n,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:n};b=P(b);
w&&$(this._eventManager.ghostCtx,u,t,l,n,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:r[f],dataSeries:g,point:{x:0<=r[f].y?l:u,y:t+(n-t)/2},direction:0>r[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(u,l),y1:t,x2:Math.max(u,l),y2:n},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
...
k&&(g=k);g>p&&(g=p);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length){var x=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():
u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var s=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=s+g<<0,D;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(D=f[b]?f[b]:q,f[b]=m=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=u[k].y+(B[b]?B[b]:0),m=l[b]?
l[b]:q,l[b]=D=a.axisY.convertValueToPixel(B[b]);else if(m=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var z=f[b]?f[b]:0;D=q+z;m+=z;f[b]=z+(m-D)}else z=l[b]?l[b]:0,D=m-z,m=q-z,l[b]=z+(m-D);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];$(c,D,s,m,C,b,0,null,x,!1,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:D,y1:s,x2:m,y2:C};b=P(b);w&&$(this._eventManager.ghostCtx,D,s,m,C,b,0,null,!1,!1,!1,!1);
(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:u[k],dataSeries:n,point:{x:0<=u[k].y?m:D,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(D,m),y1:s,x2:Math.max(D,m),y2:C},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};n.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
...
c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var r=0;r<a.dataSeriesIndexes.length;r++){var h=a.dataSeriesIndexes[r],n=this.data[h],u=n.dataPoints;if(0<u.length){var s=5<g&&n.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===
typeof u[k].y){p=a.axisX.convertValueToPixel(b);var A;A=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;var C=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,D=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=A+(t[b]?t[b]:0);if(0>=t[b])continue;A=f[b]?f[b]:q;f[b]=m=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)B[b]=A+(B[b]?B[b]:0),m=l[b]?l[b]:q,l[b]=A=a.axisY.convertValueToPixel(B[b]);
else if(m=a.axisY.convertValueToPixel(A),0<=u[k].y){var z=f[b]?f[b]:0;A=q+z;m+=z;a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x2-m)&&(m=e.x2);f[b]=z+(m-A)}else z=l[b]?l[b]:0,A=m-z,m=q-z,a.dataSeriesIndexes.length-1===r&&1>=Math.abs(e.x1-A)&&(A=e.x1),l[b]=z+(m-A);b=u[k].color?u[k].color:n._colorSet[k%n._colorSet.length];$(c,A,C,m,D,b,0,null,s,!1,!1,!1,n.fillOpacity);b=n.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:A,y1:C,x2:m,
y2:D};b=P(b);w&&$(this._eventManager.ghostCtx,A,C,m,D,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||n.indexLabel||u[k].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:n,point:{x:0<=u[k].y?m:A,y:p},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(A,m),y1:C,x2:Math.max(A,m),y2:D},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.xScaleAnimation,easingFunction:K.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:
q}}};n.prototype.renderArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(n,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(n,C),l.lineTo(D.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(n,u),l.beginPath(),l.moveTo(n,u),D={x:n,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,
f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,B=[],k=this.plotArea,m;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=P(B);l.fillStyle=B;B=[];
d=!0;var h=0,n,u,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;if(0<r.length){var z=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||z,y=v;f.fillStyle=z;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var Q=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=N(c,g.lineThickness);f.setLineDash(aa)}for(var ja=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||
s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof r[h].y)g.connectNullData||(ja||d)||b(),ja=!0;else{n=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[h].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,D=m,c=g.nullDataLineDashType,f.setLineDash(Q)),f.lineTo(n,u),w&&l.lineTo(n,u)):(f.beginPath(),f.moveTo(n,u),w&&
(l.beginPath(),l.moveTo(n,u)),D={x:n,y:u}),ja=d=!1):(f.lineTo(n,u),w&&l.lineTo(n,u),0==h%250&&b());m={x:n,y:u};h<r.length-1&&(y!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||v,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Y=g.dataPointIds[h];this._eventManager.objectMap[Y]={id:Y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:n,y1:u};0!==r[h].markerSize&&
(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,n,u,f),B.push(s),Y=P(Y),w&&B.push({x:n,y:u,ctx:l,type:s.type,size:s.size,color:Y,borderColor:Y,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:n,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:z})}b();V.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};
...
C;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var y=N(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,E=N(z,m.lineThickness);b.setLineDash(E)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(m.connectNullData?b.setLineDash&&(0<s.length&&(m.options.nullDataLineDashType||!p[q-1].lineDashType))&&(s[s.length-1].newLineDashArray=y,
z=m.nullDataLineDashType):(d(),s=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);var Q=m.dataPointIds[q];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};s[s.length]={x:g,y:r};q<p.length-1&&(D!==(p[q].lineColor||C)||z!==(p[q].lineDashType||m.lineDashType))&&(D=p[q].lineColor||C,s[s.length-1].newStrokeStyle=D,b.setLineDash&&(p[q].lineDashType?(z=p[q].lineDashType,s[s.length-1].newLineDashArray=N(z,m.lineThickness)):
(z=m.lineDashType,s[s.length-1].newLineDashArray=E)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<m.markerSize)){var aa=m.getMarkerProperties(q,g,r,b);l.push(aa);Q=P(Q);w&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:Q,borderColor:Q,borderThickness:aa.borderThickness})}(p[q].indexLabel||m.indexLabel||p[q].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:m,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:A});
r=!1}d();V.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,
dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};n.prototype.renderStepArea=function(a){var d,c;function b(){D&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=A:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=A),f.lineTo(n,C),f.lineTo(D.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(n,C),l.lineTo(D.x,C),l.closePath(),l.fill()),
...
B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=P(B);l.fillStyle=B;B=[];d=!0;var h=0,n,u,s,A=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),C,D=null;c=!1;if(0<r.length){var z=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||z,y=v;f.fillStyle=z;f.strokeStyle=v;f.lineWidth=g.lineThickness;var Q="solid";if(f.setLineDash){var aa=N(g.nullDataLineDashType,g.lineThickness),Q=g.lineDashType,E=N(Q,g.lineThickness);f.setLineDash(E)}for(;h<
r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Y=u;"number"!==typeof r[h].y?(g.connectNullData||(c||d)||b(),c=!0):(n=a.axisX.convertValueToPixel(s),u=a.axisY.convertValueToPixel(r[h].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||Q===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=n,c=u,n=m.x,u=m.y,b(),f.moveTo(m.x,m.y),n=d,u=c,D=m,Q=g.nullDataLineDashType,
f.setLineDash(aa)),f.lineTo(n,Y),f.lineTo(n,u),w&&(l.lineTo(n,Y),l.lineTo(n,u))):(f.beginPath(),f.moveTo(n,u),w&&(l.beginPath(),l.moveTo(n,u)),D={x:n,y:u}),c=d=!1):(f.lineTo(n,Y),w&&l.lineTo(n,Y),f.lineTo(n,u),w&&l.lineTo(n,u),0==h%250&&b()),m={x:n,y:u},h<r.length-1&&(y!==(r[h].lineColor||v)||Q!==(r[h].lineDashType||g.lineDashType))&&(b(),y=r[h].lineColor||v,f.strokeStyle=y,f.setLineDash&&(r[h].lineDashType?(Q=r[h].lineDashType,f.setLineDash(N(Q,g.lineThickness))):(Q=g.lineDashType,f.setLineDash(E)))),
s=g.dataPointIds[h],this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:n,y1:u},0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(Y=g.getMarkerProperties(h,n,u,f),B.push(Y),s=P(s),w&&B.push({x:n,y:u,ctx:l,type:Y.type,size:Y.size,color:s,borderColor:s,borderThickness:Y.borderThickness})),(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[h],dataSeries:g,point:{x:n,
y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:z}))}b();V.drawMarkers(B)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&f.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.clearRect(k.x1,k.y1,k.width,k.height),this._eventManager.ghostCtx.restore());
f.restore();return{source:e,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};n.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:
c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,h=[],k=[],m=[],p=[],q=0,g,r,n=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,u,x,A;w&&s.beginPath();b.save();w&&s.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(s.beginPath(),s.rect(t.x1,t.y1,t.width,t.height),s.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var D=a.dataSeriesIndexes[C],z=this.data[D],v=z.dataPoints;z.dataPointIndexes=
[];for(q=0;q<v.length;q++)D=v[q].x.getTime?v[q].x.getTime():v[q].x,z.dataPointIndexes[D]=q,e[D]||(m.push(D),e[D]=!0);m.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){D=a.dataSeriesIndexes[C];z=this.data[D];v=z.dataPoints;x=!0;k=[];q=z.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:D};q=P(q);s.fillStyle=q;if(0<m.length){var e=z._colorSet[0],y=z.lineColor=z.options.lineColor||e,Q=y;b.fillStyle=e;b.strokeStyle=y;b.lineWidth=z.lineThickness;A="solid";if(b.setLineDash){var aa=
N(z.nullDataLineDashType,z.lineThickness);A=z.lineDashType;var E=N(A,z.lineThickness);b.setLineDash(E)}for(var Y=!0,q=0;q<m.length;q++){var f=m[q],fa=null,fa=0<=z.dataPointIndexes[f]?v[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||x)||d(),Y=!0;else{g=a.axisX.convertValueToPixel(f);var ma=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=
fa.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(fa.y),r-=ma;k.push({x:g,y:n-ma});h[f]=n-r;x||Y?(!x&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||A===z.lineDashType&&z.lineDashType!==z.nullDataLineDashType)&&(x=k.pop(),A=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(A),k.push(x),A=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),
s.moveTo(g,r))),Y=x=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:n-ma})));u={x:g,y:r};q<v.length-1&&(Q!==(v[q].lineColor||y)||A!==(v[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:n-ma}),Q=v[q].lineColor||y,b.strokeStyle=Q,b.setLineDash&&(v[q].lineDashType?(A=v[q].lineDashType,b.setLineDash(N(A,z.lineThickness))):(A=z.lineDashType,b.setLineDash(E))));if(0<=z.dataPointIndexes[f]){var F=z.dataPointIds[z.dataPointIndexes[f]];
this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ma=z.getMarkerProperties(z.dataPointIndexes[f],g,r,b),l.push(ma),f=P(F),w&&l.push({x:g,y:r,ctx:s,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",
dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete z.dataPointIndexes}V.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),s.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};n.prototype.renderStackedArea100=function(a){function d(){for(0<z.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&A.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=z.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(A.closePath(),A.fill(),A.beginPath());k=[]}
var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],m=[],p=[],q=0,g,r,n,s,u,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),A=this._eventManager.ghostCtx;b.save();w&&A.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(A.beginPath(),A.rect(l.x1,l.y1,l.width,l.height),A.clip());for(var e=[],C=0;C<a.dataSeriesIndexes.length;C++){var v=a.dataSeriesIndexes[C],
z=this.data[v],y=z.dataPoints;z.dataPointIndexes=[];for(q=0;q<y.length;q++)v=y[q].x.getTime?y[q].x.getTime():y[q].x,z.dataPointIndexes[v]=q,e[v]||(m.push(v),e[v]=!0);m.sort(Pa)}for(C=0;C<a.dataSeriesIndexes.length;C++){v=a.dataSeriesIndexes[C];z=this.data[v];y=z.dataPoints;s=!0;e=z.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:v};e=P(e);A.fillStyle=e;k=[];if(0<m.length){var e=z._colorSet[q%z._colorSet.length],E=z.lineColor=z.options.lineColor||e,Q=E;b.fillStyle=e;b.strokeStyle=
E;b.lineWidth=z.lineThickness;u="solid";if(b.setLineDash){var aa=N(z.nullDataLineDashType,z.lineThickness);u=z.lineDashType;var F=N(u,z.lineThickness);b.setLineDash(F)}for(var Y=!0,q=0;q<m.length;q++){var f=m[q],fa=null,fa=0<=z.dataPointIndexes[f]?y[z.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!z.connectNullData||!Y)))if("number"!==typeof fa.y)z.connectNullData||(Y||s)||d(),Y=!0;else{var ma;ma=0!==a.dataPointYSums[f]?100*(fa.y/a.dataPointYSums[f]):
0;g=a.axisX.convertValueToPixel(f);var ba=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ma+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ma),r-=ba;k.push({x:g,y:x-ba});h[f]=x-r;s||Y?(!s&&z.connectNullData?(b.setLineDash&&(z.options.nullDataLineDashType||u===z.lineDashType&&z.lineDashType!==z.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(n.x,
n.y),k.push(u),k.push(s),u=z.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&A.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(A.beginPath(),A.moveTo(g,r))),Y=s=!1):(b.lineTo(g,r),w&&A.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&A.moveTo(g,r),k.push({x:g,y:x-ba})));n={x:g,y:r};q<y.length-1&&(Q!==(y[q].lineColor||E)||u!==(y[q].lineDashType||z.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:x-ba}),Q=y[q].lineColor||E,b.strokeStyle=Q,b.setLineDash&&(y[q].lineDashType?(u=y[q].lineDashType,
b.setLineDash(N(u,z.lineThickness))):(u=z.lineDashType,b.setLineDash(F))));if(0<=z.dataPointIndexes[f]){var G=z.dataPointIds[z.dataPointIndexes[f]];this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:z.dataPointIndexes[f],x1:g,y1:r}}0<=z.dataPointIndexes[f]&&0!==fa.markerSize&&(0<fa.markerSize||0<z.markerSize)&&(ba=z.getMarkerProperties(q,g,r,b),t.push(ba),f=P(G),w&&t.push({x:g,y:r,ctx:A,type:ba.type,size:ba.size,color:f,borderColor:f,borderThickness:ba.borderThickness}));
(fa.indexLabel||z.indexLabel||fa.indexLabelFormatter||z.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:fa,dataSeries:z,point:{x:g,y:r},direction:0>y[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&A.moveTo(g,r)}delete z.dataPointIndexes}V.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),A.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};n.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
var g=q[e].z,s=2*Math.max(Math.sqrt((t===h?n/2:r+(n-r)/(t-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=s;c.globalAlpha=p.fillOpacity;V.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var u=p.dataPointIds[e];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:e,x1:f,y1:l,size:s};s=P(u);w&&V.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,s,s,g.borderThickness);(q[e].indexLabel||p.indexLabel||
...
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof m[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(m[e].y);var g=k.getMarkerProperties(e,f,l,c);c.globalAlpha=k.fillOpacity;V.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&m.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:e,x1:f,y1:l},p=P(p),w&&V.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(m[e].indexLabel||k.indexLabel||m[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:m[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),p=f,q=l)}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};n.prototype.renderCandlestick=
...
l.height),b.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var v=a.dataSeriesIndexes[n],u=this.data[v],x=u.dataPoints;if(0<x.length)for(var A=5<r&&u.bevelEnabled?!0:!1,t=0;t<x.length;t++)if(x[t].getTime?g=x[t].x.getTime():g=x[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[t].y)&&x[t].y.length&&"number"===typeof x[t].y[0]&&"number"===typeof x[t].y[1]&&"number"===typeof x[t].y[2]&&"number"===typeof x[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(x[t].y[0]);
m=a.axisY.convertValueToPixel(x[t].y[1]);p=a.axisY.convertValueToPixel(x[t].y[2]);q=a.axisY.convertValueToPixel(x[t].y[3]);var C=h-r/2<<0,D=C+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=x[t].color?x[t].color:u._colorSet[0],z=Math.round(Math.max(1,0.15*r)),y=0===z%2?0:0.5,E=u.dataPointIds[t];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:t,x1:C,y1:k,x2:D,y2:m,x3:h,y3:p,x4:h,y4:q,borderThickness:z,color:e};c.strokeStyle=e;c.beginPath();
c.lineWidth=z;b.lineWidth=Math.max(z,4);"candlestick"===u.type?(c.moveTo(h-y,m),c.lineTo(h-y,Math.min(k,q)),c.stroke(),c.moveTo(h-y,Math.max(k,q)),c.lineTo(h-y,p),c.stroke(),$(c,C,Math.min(k,q),D,Math.max(k,q),x[t].y[0]<=x[t].y[3]?u.risingColor:f,z,e,A,A,!1,!1,u.fillOpacity),w&&(e=P(E),b.strokeStyle=e,b.moveTo(h-y,m),b.lineTo(h-y,Math.min(k,q)),b.stroke(),b.moveTo(h-y,Math.max(k,q)),b.lineTo(h-y,p),b.stroke(),$(b,C,Math.min(k,q),D,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-
y,m),c.lineTo(h-y,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(C,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(D,q),c.stroke(),w&&(e=P(E),b.strokeStyle=e,b.moveTo(h-y,m),b.lineTo(h-y,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(C,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(D,q),b.stroke()));(x[t].indexLabel||u.indexLabel||x[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:x[t],dataSeries:u,point:{x:C+(D-C)/2,y:a.axisY.reversed?
p:m},direction:1,bounds:{x1:C,y1:Math.min(m,p),x2:D,y2:Math.max(m,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};n.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,t,h,k,m,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?
...
this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();w&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();w&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var n=!1,n=!!a.axisY.reversed,v=0;v<a.dataSeriesIndexes.length;v++){var u=a.dataSeriesIndexes[v],x=this.data[u],A=x.dataPoints;if(0<A.length)for(var C=5<r&&x.bevelEnabled?!0:!1,l=0;l<A.length;l++)if(A[l].getTime?g=A[l].x.getTime():g=A[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&
!s(A[l].y)&&A[l].y.length&&"number"===typeof A[l].y[0]&&"number"===typeof A[l].y[1]&&"number"===typeof A[l].y[2]&&"number"===typeof A[l].y[3]&&"number"===typeof A[l].y[4]&&5===A[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(A[l].y[0]);k=a.axisY.convertValueToPixel(A[l].y[1]);m=a.axisY.convertValueToPixel(A[l].y[2]);p=a.axisY.convertValueToPixel(A[l].y[3]);q=a.axisY.convertValueToPixel(A[l].y[4]);var D=t-r/2<<0,z=t+r/2<<0,e=A[l].color?A[l].color:x._colorSet[0],y=Math.round(Math.max(1,
0.15*r)),E=0===y%2?0:0.5,Q=A[l].whiskerColor?A[l].whiskerColor:A[l].color?x.whiskerColor?x.whiskerColor:A[l].color:x.whiskerColor?x.whiskerColor:e,aa="number"===typeof A[l].whiskerThickness?A[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=A[l].whiskerDashType?A[l].whiskerDashType:x.whiskerDashType,Y=s(A[l].whiskerLength)?s(x.options.whiskerLength)?r:x.whiskerLength:A[l].whiskerLength,Y="number"===typeof Y?0>=Y?0:Y>=r?r:Y:"string"===typeof Y?parseInt(Y)*r/100>
r?r:parseInt(Y)*r/100:r,fa=1===Math.round(aa)%2?0.5:0,ma=A[l].stemColor?A[l].stemColor:A[l].color?x.stemColor?x.stemColor:A[l].color:x.stemColor?x.stemColor:e,ba="number"===typeof A[l].stemThickness?A[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(ba)%2?0.5:0,J=A[l].stemDashType?A[l].stemDashType:x.stemDashType,H=A[l].lineColor?A[l].lineColor:A[l].color?x.lineColor?x.lineColor:A[l].color:x.lineColor?x.lineColor:e,M="number"===typeof A[l].lineThickness?
A[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,S=A[l].lineDashType?A[l].lineDashType:x.lineDashType,L=1===Math.round(M)%2?0.5:0,R=x.upperBoxColor,xa=x.lowerBoxColor,sa=s(x.options.fillOpacity)?1:x.fillOpacity,O=x.dataPointIds[l];this._eventManager.objectMap[O]={id:O,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:D,y1:h,x2:z,y2:k,x3:t,y3:m,x4:t,y4:p,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:ma,whiskerThickness:aa,whiskerLength:Y,whiskerColor:Q,
lineThickness:M,lineColor:H};c.save();0<ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=ba,c.setLineDash&&c.setLineDash(N(J,ba)),c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,m),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();$(c,D,Math.min(q,k),z,Math.max(k,q),xa,0,e,n?C:!1,n?!1:C,!1,!1,sa);c.beginPath();$(c,D,Math.min(m,q),z,Math.max(q,m),R,0,e,n?!1:C,n?C:!1,!1,!1,sa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(D-E,Math.min(k,m)-E,z-D+2*E,Math.max(k,
m)-Math.min(k,m)+2*E);c.stroke();c.save();0<M&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(N(S,M)),c.strokeStyle=H,c.lineWidth=M,c.moveTo(D,q-L),c.lineTo(z,q-L),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(F,aa)),c.strokeStyle=Q,c.lineWidth=aa,c.moveTo(t-Y/2<<0,p-fa),c.lineTo(t+Y/2<<0,p-fa),c.stroke(),c.moveTo(t-Y/2<<0,h+fa),c.lineTo(t+Y/2<<0,h+fa),c.stroke());c.restore();w&&(e=P(O),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(t-E-G,k),b.lineTo(t-
E-G,Math.max(h,p)),b.stroke(),b.moveTo(t-E-G,Math.min(h,p)),b.lineTo(t-E-G,m),b.stroke()),$(b,D,Math.max(k,m),z,Math.min(k,m),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(t+Y/2,p-fa),b.lineTo(t-Y/2,p-fa),b.stroke(),b.moveTo(t+Y/2,h+fa),b.lineTo(t-Y/2,h+fa),b.stroke()));(A[l].indexLabel||x.indexLabel||A[l].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:A[l],dataSeries:x,point:{x:D+(z-D)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:D,
y1:Math.min(h,p),x2:z,y2:Math.max(h,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,
dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:n,y1:l,x2:v,y2:t};$(c,n,l,v,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=P(u);w&&$(this._eventManager.ghostCtx,n,l,v,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:n+(v-n)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?
...
!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&v||v++;for(var x=0;x<a.dataSeriesIndexes.length;x++){var A=a.dataSeriesIndexes[x],C=this.data[A],D=C.dataPoints,z=s(C._linkedSeries)?!1:C._linkedSeries.type.match(/(bar|column)/ig)&&C._linkedSeries.visible?!0:!1,E=0;if(z)for(e=C._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&E||(this.data[u].type.match(/(range)/ig)&&(f=!0),E++);e=this.options.dataPointMinWidth?
this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(z?v:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(z?v:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:
0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(n)/Math.log(a.axisX.range):Math.abs(n)/Math.abs(a.axisX.range))/(z?v:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>t&&(u=t);if(0<D.length)for(var F=C._colorSet,t=0;t<D.length;t++){var e=C.lineColor=C.options.color?C.options.color:F[0],Q={color:D[t].whiskerColor?
D[t].whiskerColor:D[t].color?C.whiskerColor?C.whiskerColor:D[t].color:C.whiskerColor?C.whiskerColor:e,thickness:s(D[t].whiskerThickness)?C.whiskerThickness:D[t].whiskerThickness,dashType:D[t].whiskerDashType?D[t].whiskerDashType:C.whiskerDashType,length:s(D[t].whiskerLength)?s(C.options.whiskerLength)?u:C.options.whiskerLength:D[t].whiskerLength,trimLength:s(D[t].whiskerLength)?s(C.options.whiskerLength)?50:0:0};Q.length="number"===typeof Q.length?0>=Q.length?0:Q.length>=u?u:Q.length:"string"===typeof Q.length?
parseInt(Q.length)*u/100>u?u:parseInt(Q.length)*u/100>u:u;Q.thickness="number"===typeof Q.thickness?0>Q.thickness?0:Math.round(Q.thickness):2;var aa={color:D[t].stemColor?D[t].stemColor:D[t].color?C.stemColor?C.stemColor:D[t].color:C.stemColor?C.stemColor:e,thickness:D[t].stemThickness?D[t].stemThickness:C.stemThickness,dashType:D[t].stemDashType?D[t].stemDashType:C.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;D[t].getTime?r=D[t].x.getTime():
r=D[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax)&&!s(D[t].y)&&D[t].y.length&&"number"===typeof D[t].y[0]&&"number"===typeof D[t].y[1]){var ja=a.axisX.convertValueToPixel(r);b?k=ja:h=ja;ja=a.axisY.convertValueToPixel(D[t].y[0]);b?m=ja:q=ja;ja=a.axisY.convertValueToPixel(D[t].y[1]);b?p=ja:g=ja;b?(q=a.axisX.reversed?k+(z?v:1)*u/2-(z?E-1:0)*u<<0:k-(z?v:1)*u/2+(z?E-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(m=a.axisX.reversed?h+(z?v:1)*u/2-(z?E-1:0)*u<<0:h-(z?v:1)*u/2+(z?
E-1:0)*u<<0,p=a.axisX.reversed?m-u<<0:m+u<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&m>p&&(ja=m,m=p,p=ja);ja=C.dataPointIds[t];this._eventManager.objectMap[ja]={id:ja,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:t,x1:Math.min(m,p),y1:Math.min(q,g),x2:Math.max(p,m),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:Q};y(c,Math.min(m,p),Math.min(q,g),Math.max(p,m),Math.max(g,q),e,Q,aa,b);w&&y(this._eventManager.ghostCtx,m,q,p,g,e,Q,aa,b);if(D[t].indexLabel||C.indexLabel||D[t].indexLabelFormatter||
...
m/2-(a.previousDataSeriesCount+p)*m<<0:h-a.plotType.totalDataSeries*m/2+(a.previousDataSeriesCount+p)*m<<0;var v=a.axisX.reversed?h-m<<0:h+m<<0;l>t&&(b=l,l=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];$(c,l,h,t,v,b,0,null,n,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:t,y2:v};b=P(b);w&&$(this._eventManager.ghostCtx,l,h,t,v,b,0,null,!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||
...
color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,
animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};n.prototype.renderRangeArea=function(a){function d(){if(x){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=m.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<m.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();
b.moveTo(r,n);e.beginPath();e.moveTo(r,n);x={x:r,y:n};h=[];h.push({x:r,y1:n,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],m=this.data[k],p=m.dataPoints,f=m.id;
this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=P(f);e.fillStyle=f;var f=[],q=!0,g=0,r,n,s,u,x=null;if(0<p.length){var v=m._colorSet[g%m._colorSet.length],C=m.lineColor=m.options.lineColor||v,D=C;b.fillStyle=v;b.strokeStyle=C;b.lineWidth=m.lineThickness;var z="solid";if(b.setLineDash){var y=N(m.nullDataLineDashType,m.lineThickness),z=m.lineDashType,E=N(z,m.lineThickness);b.setLineDash(E)}for(var Q=!0;g<p.length;g++)if(u=p[g].x.getTime?p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||
u>a.axisX.dataInfo.viewPortMax&&(!m.connectNullData||!Q)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);n=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||Q?(m.connectNullData&&!q?(b.setLineDash&&(m.options.nullDataLineDashType||z===m.lineDashType&&m.lineDashType!==m.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,z=m.nullDataLineDashType,b.setLineDash(y)),b.lineTo(r,n),w&&e.lineTo(r,
n),h.push({x:r,y1:n,y2:s})):(b.beginPath(),b.moveTo(r,n),x={x:r,y:n},h=[],h.push({x:r,y1:n,y2:s}),w&&(e.beginPath(),e.moveTo(r,n))),Q=q=!1):(b.lineTo(r,n),h.push({x:r,y1:n,y2:s}),w&&e.lineTo(r,n),0==g%250&&d());u=m.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:n,y2:s};g<p.length-1&&(D!==(p[g].lineColor||C)||z!==(p[g].lineDashType||m.lineDashType))&&(d(),D=p[g].lineColor||C,h[h.length-1].newStrokeStyle=D,b.strokeStyle=D,b.setLineDash&&
(p[g].lineDashType?(z=p[g].lineDashType,h[h.length-1].newLineDashArray=N(z,m.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(z=m.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<m.markerSize)){var aa=m.getMarkerProperties(g,r,s,b);f.push(aa);var F=P(u);w&&f.push({x:r,y:s,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness});aa=m.getMarkerProperties(g,r,n,b);f.push(aa);F=P(u);w&&f.push({x:r,
y:n,ctx:e,type:aa.type,size:aa.size,color:F,borderColor:F,borderThickness:aa.borderThickness})}if(p[g].indexLabel||m.indexLabel||p[g].indexLabelFormatter||m.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:0,point:{x:r,y:n},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:v}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:m,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:
-1,color:v})}else Q||q||d(),Q=!0;d();V.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());
b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};n.prototype.renderRangeSplineArea=function(a){function d(a,c){var d=v(n,2);if(0<d.length){if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var f=0;f<d.length-3;f+=3){if(d[f].newStrokeStyle||d[f].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),d[f].newStrokeStyle&&(b.strokeStyle=d[f].newStrokeStyle),
d[f].newLineDashArray&&b.setLineDash(d[f].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}}b.beginPath();b.moveTo(d[0].x,d[0].y);w&&(e.beginPath(),e.moveTo(d[0].x,d[0].y));for(f=0;f<d.length-3;f+=3)b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y),w&&e.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=v(s,2);b.lineTo(s[s.length-1].x,s[s.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,
d[f-2].y,d[f-3].x,d[f-3].y),w&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();w&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-3;f+=3,g++){if(n[g].newStrokeStyle||n[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),n[g].newStrokeStyle&&(b.strokeStyle=n[g].newStrokeStyle),n[g].newLineDashArray&&
b.setLineDash(n[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}d=v(n,2);b.moveTo(d[0].x,d[0].y);for(g=f=0;f<d.length-3;f+=3,g++){if(n[g].newStrokeStyle||n[g].newLineDashArray)b.stroke(),b.beginPath(),b.moveTo(d[f].x,d[f].y),n[g].newStrokeStyle&&(b.strokeStyle=n[g].newStrokeStyle),n[g].newLineDashArray&&b.setLineDash(n[g].newLineDashArray);b.bezierCurveTo(d[f+1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y)}b.stroke()}b.beginPath()}}var c=a.targetCanvasCtx||
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],m=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=P(f);e.fillStyle=f;var f=[],p=0,q,
g,r,n=[],s=[];if(0<m.length){var u=k._colorSet[p%k._colorSet.length],x=k.lineColor=k.options.lineColor||u,A=x;b.fillStyle=u;b.lineWidth=k.lineThickness;var C="solid",D;if(b.setLineDash){var z=N(k.nullDataLineDashType,k.lineThickness),C=k.lineDashType;D=N(C,k.lineThickness)}for(g=!1;p<m.length;p++)if(q=m[p].x.getTime?m[p].x.getTime():m[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==m[p].y&&m[p].y.length&&"number"===typeof m[p].y[0]&&"number"===
typeof m[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(m[p].y[0]);r=a.axisY.convertValueToPixel(m[p].y[1]);var y=k.dataPointIds[p];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:r};n[n.length]={x:q,y:g};s[s.length]={x:q,y:r};p<m.length-1&&(A!==(m[p].lineColor||x)||C!==(m[p].lineDashType||k.lineDashType))&&(A=m[p].lineColor||x,n[n.length-1].newStrokeStyle=A,b.setLineDash&&(m[p].lineDashType?(C=m[p].lineDashType,
n[n.length-1].newLineDashArray=N(C,k.lineThickness)):(C=k.lineDashType,n[n.length-1].newLineDashArray=D)));if(0!==m[p].markerSize&&(0<m[p].markerSize||0<k.markerSize)){var E=k.getMarkerProperties(p,q,g,b);f.push(E);var Q=P(y);w&&f.push({x:q,y:g,ctx:e,type:E.type,size:E.size,color:Q,borderColor:Q,borderThickness:E.borderThickness});E=k.getMarkerProperties(p,q,r,b);f.push(E);Q=P(y);w&&f.push({x:q,y:r,ctx:e,type:E.type,size:E.size,color:Q,borderColor:Q,borderThickness:E.borderThickness})}if(m[p].indexLabel||
k.indexLabel||m[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:m[p].y[0]<=m[p].y[1]?-1:1,color:u}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:m[p],dataSeries:k,indexKeyword:1,point:{x:q,y:r},direction:m[p].y[0]<=m[p].y[1]?1:-1,color:u});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<n.length&&(k.options.nullDataLineDashType||!m[p-1].lineDashType))&&(n[n.length-
1].newLineDashArray=z,C=k.nullDataLineDashType):(d(D,x),n=[],s=[])),g=!0;d(D,x);V.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:K.xClipAnimation,easingFunction:K.easing.linear,animationBase:0}}};n.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,e=null,f=this.plotArea,l=0,t,h,k,m,p=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),l=this.options.dataPointMinWidth?this.dataPointMinWidth:
...
a.dataSeriesIndexes[g],s=this.data[n],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,x=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var A=5<q&&s.bevelEnabled?!0:!1,C=!1,D=null,z=null,l=0;l<v.length;l++)if(v[l].getTime?m=v[l].x.getTime():m=v[l].x,"number"!==typeof v[l].y){if(0<l&&!C&&s.connectNullData)var y=
...
g)*q<<0;var E=a.axisX.reversed?t-q<<0:t+q<<0;h>k&&(e=h,h=k,k=e);a.axisY.reversed&&(e=h,h=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:l,x1:t,y1:h,x2:E,y2:k};var Q=v[l].color?v[l].color:0<v[l].y?s.risingColor:s.fallingColor;$(c,t,h,E,k,Q,0,Q,A,A,!1,!1,s.fillOpacity);e=P(e);w&&$(this._eventManager.ghostCtx,t,h,E,k,e,0,null,!1,!1,!1,!1);var aa,Q=t;aa="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==
typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?h:k:0<v[l].y?k:h;0<l&&D&&(!C||s.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(N(y,u)),c.beginPath(),c.moveTo(D,z-x),c.lineTo(Q,aa-x),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(D,z-x),b.lineTo(Q,aa-x),0<u&&b.stroke()));C=!1;D=E;z=0<v[l].y?h:k;Q=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";
c.lineWidth=u;c.setLineDash&&(Q=N(Q,u),c.setLineDash(Q));(v[l].indexLabel||s.indexLabel||v[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:s,point:{x:t+(E-t)/2,y:0<=v[l].y?h:k},direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:t,y1:Math.min(h,k),x2:E,y2:Math.max(h,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,
0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:K.fadeInAnimation,easingFunction:K.easing.easeInQuad,animationBase:0}}};var ga=function(a,d,c,b,e,f,l,h,n){if(!(0>c)){"undefined"===typeof h&&
...
k.indexLabel?n.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";n._eventManager.objectMap[l]=h;h.center={x:A.x,y:A.y};h.y=f.y;h.radius=z;h.percentInnerRadius=E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%k._colorSet.length];h.indexLabelLineThickness=s(f.indexLabelLineThickness)?k.indexLabelLineThickness:f.indexLabelLineThickness;
...
m.length;b++){var c=g[b].startAngle,d=g[b].endAngle;if(d>c){var e=0.07*z*Math.cos(g[b].midAngle),f=0.07*z*Math.sin(g[b].midAngle),l=!1;if(m[b].exploded){if(1E-9<Math.abs(g[b].center.x-(A.x+e))||1E-9<Math.abs(g[b].center.y-(A.y+f)))g[b].center.x=A.x+e*a,g[b].center.y=A.y+f*a,l=!0}else if(0<Math.abs(g[b].center.x-A.x)||0<Math.abs(g[b].center.y-A.y))g[b].center.x=A.x+e*(1-a),g[b].center.y=A.y+f*(1-a),l=!0;l&&(e={},e.dataSeries=k,e.dataPoint=k.dataPoints[b],e.index=b,n.toolTip.highlightObjects([e]));
ga(n.plotArea.ctx,g[b].center,g[b].radius,m[b].color?m[b].color:k._colorSet[b%k._colorSet.length],k.type,c,d,k.fillOpacity,g[b].percentInnerRadius)}}a=n.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<m.length;b++)c=g[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=c.indexLabelTextBlock.height/2,d=0,d="left"===c.hemisphere?"inside"!==k.indexLabelPlacement?-(c.indexLabelTextBlock.width+p):-c.indexLabelTextBlock.width/2:"inside"!==
...
A.y,p.indexLabelTextBlock.x-A.x))}return k}function l(){var a=n.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&z-d<=y)l=!1;l&&(z-=d);d=0;if("inside"!==k.indexLabelPlacement){w=z*v;for(a=0;a<m.length;a++){var h=g[a];h.indexLabelTextBlock.x=A.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=A.y+w*Math.sin(h.midAngle);h.indexLabelAngle=
h.midAngle;h.radius=z;h.percentInnerRadius=E}for(var t,u,a=0;a<m.length;a++){var h=g[a],s=e(a);if(null!==s){t=g[a];u=g[s];var C=0,C=b(t,u)-r;if(0>C){for(var D=u=0,F=0;F<m.length;F++)F!==a&&g[F].hemisphere===h.hemisphere&&(g[F].indexLabelTextBlock.y<h.indexLabelTextBlock.y?u++:D++);u=C/(u+D||1)*D;var D=-1*(C-u),J=F=0;"right"===h.hemisphere?(F=f(a,u),D=-1*(C-F),J=f(s,D),+J.toFixed(x)<+D.toFixed(x)&&+F.toFixed(x)<=+u.toFixed(x)&&f(a,-(D-J))):(F=f(s,u),D=-1*(C-F),J=f(a,D),+J.toFixed(x)<+D.toFixed(x)&&
+F.toFixed(x)<=+u.toFixed(x)&&f(s,-(D-J)))}}}}else for(a=0;a<m.length;a++)h=g[a],w="pie"===k.type?0.7*z:0.8*z,s=A.x+w*Math.cos(h.midAngle),u=A.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=s,h.indexLabelTextBlock.y=u;for(a=0;a<m.length;a++)if(h=g[a],s=h.indexLabelTextBlock.measureText(),0!==s.height&&0!==s.width)s=s=0,"right"===h.hemisphere?(s=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+p),s*=-1):s=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<s&&(!l&&h.indexLabelText&&
(u="right"===h.hemisphere?q.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-q.x1,0.3*h.indexLabelTextBlock.maxWidth>u?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*u,0.3*h.indexLabelTextBlock.maxWidth<u&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-A.y)<z||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2-A.y)<z)&&(s/=Math.abs(Math.cos(h.indexLabelAngle)),9<s&&(s*=0.3),s>d&&(d=s)),s=s=0,0<h.indexLabelAngle&&
h.indexLabelAngle<Math.PI?(s=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),s*=-1):s=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<s&&(!l&&h.indexLabelText&&(u=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,s*u)&&f(a,2*u)),Math.abs(h.indexLabelTextBlock.x-A.x)<z&&(s/=Math.abs(Math.sin(h.indexLabelAngle)),9<s&&(s*=0.3),s>d&&(d=s)));var H=function(a,b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+m.length)%m.length);d.sort(function(a,b){return a.y-b.y});
...
2,u=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,B=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||n>B+p||r<s-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-C),0===k%Math.max(m.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(H(d,a,c),c=a=-1,d=0)}}0<d&&H(d,a,c)})()}}function h(){n.plotArea.layoutManager.reset();n.title&&(n.title.dockInsidePlotArea||"center"===n.title.horizontalAlign&&"center"===n.title.verticalAlign)&&
...
q.height)/2;k.radius&&(z=Ra(k.radius,z));var y="undefined"!==typeof k.innerRadius&&null!==k.innerRadius?Ra(k.innerRadius,z):0.7*z;k.radius=z;"doughnut"===k.type&&(k.innerRadius=y);var E=Math.min(y/z,(z-1)/z);this.pieDoughnutClickHandler=function(a){n.isAnimating||!s(a.dataSeries.explodeOnClick)&&!a.dataSeries.explodeOnClick||(a=a.dataPoint,a.exploded=a.exploded?!1:!0,1<this.dataPoints.length&&n._animator.animate(0,500,function(a){c(a);h();n.dispatchEvent("dataAnimationIterationEnd",{chart:n});n.dispatchEvent("dataAnimationEnd",
{chart:n})}))};d();l();l();l();l();this.disableToolTip=!0;this._animator.animate(0,this.animatedRender?this.animationDuration:0,function(a){var b=n.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=n.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<m.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=m[c].color?m[c].color:k._colorSet[c%k._colorSet.length];e>d&&ga(n.plotArea.ctx,g[c].center,
...
typeof x[c].y?x[c].y:0;a+=Math.abs(x[c].y)}if(0===a)return-1;for(c=b[0]=0;c<x.length;c++)b.push(Math.abs(x[c].y)*E/a);return b}function c(){var a=W,b=T,c=L,d=V,e,f;e=Y;f=P-ba;d=Math.abs((f-e)*(b-a+(d-c))/2);c=V-L;e=f-e;f=c*(f-P);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<x.length;k++){if("undefined"===typeof x[k].y)return-1;x[k].y="number"===typeof x[k].y?x[k].y:0;g+=Math.abs(x[k].y)}if(0===g)return-1;for(var l=d[0]=0,h=0,m,p,b=b-a,l=!1,k=0;k<x.length;k++)a=Math.abs(x[k].y)*f/g,l?m=0==Number(c.toFixed(3))?
0:a/c:(p=$*$*b*b-4*Math.abs($)*a,0>p?(p=c,l=(b+p)*(e-h)/2,a-=l,m=e-h,h+=e-h,m+=0==p?0:a/p,h+=a/p,l=!0):(m=(Math.abs($)*b-Math.sqrt(p))/2,p=b-2*m/Math.abs($),h+=m,h>e&&(h-=m,p=c,l=(b+p)*(e-h)/2,a-=l,m=e-h,h+=e-h,m+=a/p,h+=a/p,l=!0),b=p)),d.push(m);return d}function b(){if(u&&x){for(var a,b,c,d,e,f,k,l,h,m,p,q,t,n,r,B=[],v=[],A={percent:null,total:null},C=null,z=0;z<x.length;z++)r=O[z],r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,B[z]=M-r-U;r=0.5*U;for(var z=0,D=x.length-1;z<
x.length||0<=D;z++,D--){b=u.reversed?x[D]:x[z];a=b.color?b.color:u.reversed?u._colorSet[(x.length-1-z)%u._colorSet.length]:u._colorSet[z%u._colorSet.length];c=b.indexLabelPlacement||u.indexLabelPlacement||"outside";n=b.indexLabelTextAlign||u.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||u.indexLabelBackgroundColor||(w?"transparent":null);e=b.indexLabelFontColor||u.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?u.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||
...
u.indexLabelWrap:!0;t=u.dataPointIds[z];y._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:O[u.reversed?x.length-1-z:z]};"inside"===u.indexLabelPlacement&&(B[z]=z!==ca?u.reversed?O[z].x2-O[z].x1:O[z].x3-O[z].x4:O[z].x3-O[z].x6,20>B[z]&&(B[z]=z!==ca?u.reversed?O[z].x3-O[z].x4:O[z].x2-O[z].x1:O[z].x2-O[z].x1,B[z]/=2));t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:B[z];if(t>B[z]||0>t)t=B[z];v[z]="inside"===
u.indexLabelPlacement?O[z].height:!1;A=y.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)C={chart:y.options,dataSeries:u,dataPoint:b,total:A.total,percent:A.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,u,z):u.indexLabelFormatter?u.indexLabelFormatter(C):u.indexLabel?y.replaceKeywordsWithValue(u.indexLabel,b,u,z):b.label?b.label:"";0>=m&&(m=0);1E3>t&&1E3-t<r&&(t+=1E3-t);R.roundRect||Ba(R);c=new ia(R,{fontSize:f,
fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:n,backgroundColor:d,maxWidth:t,maxHeight:!1===v[z]?q?4.28571429*f:1.5*f:v[z],text:b,padding:da});c.measureText();I.push({textBlock:c,id:u.reversed?D:z,isDirty:!1,lineColor:a,lineThickness:m,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=M-T-U/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:
k,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<O.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=O[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=M-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,
I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,u.reversed?(I[l].textBlock.y+I[l].height>na+C&&(I[l].textBlock.y=na+C-I[l].height),I[l].textBlock.y<sa-C&&(I[l].textBlock.y=sa-C)):(I[l].textBlock.y<na-C&&(I[l].textBlock.y=na-C),I[l].textBlock.y+I[l].height>sa+C&&(I[l].textBlock.y=sa+C-I[l].height))}function f(){var a,b,c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<O.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:
(a=O[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>xa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<xa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+U,I[e].textBlock.y=c-I[e].height/2,u.reversed?(I[e].textBlock.y+I[e].height>na+C&&(I[e].textBlock.y=na+C-I[e].height),I[e].textBlock.y<sa-C&&(I[e].textBlock.y=sa-C)):(I[e].textBlock.y<na-C&&(I[e].textBlock.y=na-C),I[e].textBlock.y+I[e].height>sa+C&&(I[e].textBlock.y=
sa+C-I[e].height)));else for(e=0;e<O.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=O[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=
q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==O.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,l;f=(P-Y+2*C)/m;l=m;for(var k,h=1;h<l;h++){e=h*f;for(var t=I.length-1;0<=t;t--)!I[t].isDirty&&(I[t].textBlock.y<e&&I[t].textBlock.y+I[t].height>e)&&(k=q(t),!(k>=I.length-1)&&I[t].textBlock.y+I[t].height+da>I[k].textBlock.y&&(I[t].textBlock.y=I[t].textBlock.y+I[t].height-e>e-I[t].textBlock.y?e+1:e-I[t].height-1))}for(k=O.length-1;0<k;k--)if(!I[k].isDirty){e=
p(k);if(0>e&&(e=0,I[e].isDirty))break;if(I[k].textBlock.y<I[e].textBlock.y+I[e].height){d=d||k;f=k;for(l=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;l+=I[f].height;l+=da;f=e;if(0>=f){f=0;l+=I[f].height;break}e=p(f);if(0>e){f=0;l+=I[f].height;break}}if(f!=k){g=I[f].textBlock.y;a-=g;a=l-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(O[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=
e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,l,k,m=1,n=0;n<2*m;n++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,k=(l=q(r)<O.length?I[q(r)]:null)?l.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(l&&e+d+da>+k.y.toFixed(6))&&(d=g.y+d+da-k.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<O.length?I[b].textBlock.y:
u.reversed?na+C:sa+C)-(0>a?u.reversed?sa-C:na-C:I[a].textBlock.y+I[a].height+da)}function n(a,b,c){var d,e,g,l=[],h=C,p=[];-1!==b&&(0<=X.indexOf(b)?(e=X.indexOf(b),X.splice(e,1)):(X.push(b),X=X.sort(function(a,b){return a-b})));if(0===X.length)l=ga;else{e=C*(1!=X.length||0!=X[0]&&X[0]!=O.length-1?2:1)/k();for(var t=0;t<O.length;t++){if(1==X.length&&0==X[0]){if(0===t){l.push(ga[t]);d=h;continue}}else 0===t&&(d=-1*h);l.push(ga[t]+d);if(0<=X.indexOf(t)||t<O.length&&0<=X.indexOf(t+1))d+=e}}g=function(){for(var a=
[],b=0;b<O.length;b++)a.push(l[b]-O[b].y1);return a}();var q={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return K.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<O.length;d++)b=g[d],c=O[d],b*=a,"undefined"===typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ha=!0;d.clearRect(A.x1,A.y1,A.x2-A.x1,
A.y2-A.y1);d.fillStyle=a.backgroundColor;d.fillRect(A.x1,A.y1,A.width,A.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[x.length-1-b]:u.dataPoints[b];e.index=u.reversed?x.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<O.length;e++)pa(d,O[e],u.fillOpacity);v(d);J&&("inside"!==u.indexLabelPlacement?m(d):f(),r(d));1<=c&&(ha=!1)},null,K.easing.easeOutQuart)}function k(){for(var a=0,b=0;b<O.length-1;b++)(0<=X.indexOf(b)||0<=X.indexOf(b+1))&&a++;return a}
...
x=u.dataPoints,A=this.plotArea,C=0.025*A.width,D=0.01*A.width,z=0,E=A.height-2*C,F=Math.min(A.width-2*D,2.8*A.height),J=!1,H=0;H<x.length;H++)if(!J&&("undefined"!==typeof x[H].indexLabel&&null!==x[H].indexLabel&&0<x[H].indexLabel.toString().length)&&(J=!0),!J&&("undefined"!==typeof x[H].label&&null!==x[H].label&&0<x[H].label.toString().length)&&(J=!0),!J&&"function"===typeof u.indexLabelFormatter||"function"===typeof x[H].indexLabelFormatter)J=!0;J=J||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&
0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&J||(D=(A.width-0.75*F)/2);var H=A.x1+D,M=A.x2-D,Y=A.y1+C,P=A.y2-C,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==x.length){var ba,G;a=75*F/100;var U=30*(M-a)/100;"funnel"===u.type?(ba=s(u.options.neckHeight)?0.35*E:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===typeof ba&&ba.match(/%$/)?(ba=parseInt(ba),ba=ba*E/100):ba=parseInt(ba),"string"===typeof G&&G.match(/%$/)?
(G=parseInt(G),G=G*a/100):G=parseInt(G),ba>E?ba=E:0>=ba&&(ba=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=ba=0,u.reversed=u.reversed?!1:!0);var D=H+a/2,W=H,T=H+a,na=u.reversed?P:Y,L=D-G/2,V=D+G/2,xa=u.reversed?Y+ba:P-ba,sa=u.reversed?Y:P;a=[];var D=[],O=[],F=[],Z=Y,ca,$=(xa-na)/(L-W),ea=-$,H="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==H){if(u.reversed)for(F.push(Z),G=H.length-1;0<G;G--)Z+=H[G],F.push(Z);else for(G=0;G<H.length;G++)Z+=H[G],F.push(Z);if(u.reversed)for(G=
0;G<H.length;G++)F[G]<xa?(a.push(L),D.push(V),ca=G):(a.push((F[G]-na+$*W)/$),D.push((F[G]-na+ea*T)/ea));else for(G=0;G<H.length;G++)F[G]<xa?(a.push((F[G]-na+$*W)/$),D.push((F[G]-na+ea*T)/ea),ca=G):(a.push(L),D.push(V));for(G=0;G<H.length-1;G++)Z=u.reversed?x[x.length-1-G].color?x[x.length-1-G].color:u._colorSet[(x.length-1-G)%u._colorSet.length]:x[G].color?x[G].color:u._colorSet[G%u._colorSet.length],G===ca?O.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:V,y3:xa,x4:D[G+1],y4:F[G+1],x5:a[G+1],y5:F[G+1],
x6:L,y6:xa,id:G,height:F[G+1]-F[G],color:Z}):O.push({x1:a[G],y1:F[G],x2:D[G],y2:F[G],x3:D[G+1],y3:F[G+1],x4:a[G+1],y4:F[G+1],id:G,height:F[G+1]-F[G],color:Z});var da=2,I=[],ha=!1,X=[],ga=[],H=!1;a=a=0;Ca(X);for(G=0;G<x.length;G++)x[G].exploded&&(H=!0,u.reversed?X.push(x.length-1-G):X.push(G));R.clearRect(A.x1,A.y1,A.width,A.height);R.fillStyle=y.backgroundColor;R.fillRect(A.x1,A.y1,A.width,A.height);if(J&&u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||
(a=I[G].textBlock.x+I[G].width,a=(M-a)/2,0==G&&(z=a),z>a&&(z=a));for(G=0;G<O.length;G++)O[G].x1+=z,O[G].x2+=z,O[G].x3+=z,O[G].x4+=z,O[G].x5&&(O[G].x5+=z,O[G].x6+=z),I[G].textBlock.x+=z}for(G=0;G<O.length;G++)z=O[G],pa(R,z,u.fillOpacity),ga.push(z.y1);v(R);J&&u.visible&&("inside"===u.indexLabelPlacement||y.animationEnabled||m(R),y.animationEnabled||r());if(!J)for(G=0;G<x.length;G++)z=u.dataPointIds[G],a={id:z,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:O[u.reversed?x.length-
1-G:G]},y._eventManager.objectMap[z]=a;!y.animationEnabled&&H?n(y,-1,0):y.animationEnabled&&!y.animatedRender&&n(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;n(y,b,500)}};return{source:R,
dest:this.plotArea.ctx,animationCallback:function(a,b){K.fadeInAnimation(a,b);1<=a&&(n(y,-1,500),v(y.plotArea.ctx||y.ctx))},easingFunction:K.easing.easeInQuad,animationBase:0}}}}};n.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,1E3/60)}}();n.prototype.cancelRequestAnimFrame=window.cancelAnimationFrame||window.webkitCancelRequestAnimationFrame||
...
0;m<this.dataSeries.length;m++){var p=this.dataSeries[m];if(p.dataPoints&&p.dataPoints.length)if("pie"!==p.type&&"doughnut"!==p.type&&"funnel"!==p.type&&"pyramid"!==p.type){var q=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:H.getDefaultLegendMarker(p._linkedSeries.type):H.getDefaultLegendMarker(p.type):
...
u=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0;"error"===p.type&&this.errorMarkerColor.push(r);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,m);q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:w,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:u};n.push(q)}else for(var x=0;x<p.dataPoints.length;x++){var A=p.dataPoints[x],q=
A.legendMarkerType?A.legendMarkerType:p.legendMarkerType?p.legendMarkerType:H.getDefaultLegendMarker(p.type),g=A.legendText?A.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:A}):A.name?A.name:"DataPoint: "+(x+1),r=A.legendMarkerColor?A.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:A.color?A.color:p.color?p.color:p._colorSet[x%p._colorSet.length],w=0.75*this.lineHeight,v=A.legendMarkerBorderColor?
A.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:A.markerBorderColor?A.markerBorderColor:p.markerBorderColor,u=A.legendMarkerBorderThickness?A.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:A.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0,g=this.chart.replaceKeywordsWithValue(g,A,p,x),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:m,dataPointIndex:x,
markerBorderColor:v,markerBorderThickness:u};(A.showInLegend||p.showInLegend&&!1!==A.showInLegend)&&n.push(q)}}!0===this.reversed&&n.reverse();if(0<n.length){p=null;r=g=A=x=0;A=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;w=0===w?0.75*this.lineHeight:w;A-=w+h;for(m=0;m<n.length;m++){q=n[m];v=A;if("line"===q.chartType||"spline"===q.chartType||
...
this.ctx.lineWidth=f/8;this.ctx.beginPath();var w=g-0.08*this.lineHeight+0.1*this.lineHeight,u=r+0.15*this.lineHeight,x=0.7*this.lineHeight,v=x+0.02*this.lineHeight;this.ctx.moveTo(w,u);this.ctx.lineTo(w+x,u);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w+x/2,u);this.ctx.lineTo(w+x/2,u+v);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(w,u+v);this.ctx.lineTo(w+x,u+v);this.ctx.stroke();this.errorMarkerColor.shift()}V.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===
q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();m=0<p?Math.max(m,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=P(q.id);this.ghostCtx.fillStyle=
g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(s,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-s,q.textBlock.height);q.x1=this.chart._eventManager.objectMap[q.id].x1=s;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=m}};oa(H,U);H.prototype.getDefaultAxisPlacement=
...
q[g].scaleBreaks._appliedBreaks.length)for(var r=q[g].scaleBreaks._appliedBreaks,w=0;w<r.length&&!(r[w].startValue>q[g].viewportMaximum);w++)r[w].endValue<q[g].viewportMinimum||(s(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=w),r[w].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=w));for(var v=w=0,u=0,x=0,A=0,y=0,D=0,z,E,F=h=0,H,J,K,r=H=J=K=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ia(q[g].ctx,{text:q[g].title,horizontalAlign:"center",
...
w;){var G=0,S=0,U=0,X=0,W=e=0,L=0,Z=0,T=0,V=0,O=0,$=0;if(c&&0<c.length)for(y=[],g=O=0;g<c.length;g++)y.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateWidth():0)),O+=y[g],L+=c[g]&&!m.isNavigator?c[g].margin:0;else y.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));P.push(y);if(b&&0<b.length)for(D=[],g=$=0;g<b.length;g++)D.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),$+=D[g],Z+=b[g]?b[g].margin:0;else D.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));R.push(D);
l=Math.round(f.x1+O+L);n=Math.round(f.x2-$-Z>m.width-p?m.width-p:f.x2-$-Z);if(a&&0<a.length)for(x=[],g=T=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(n-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),x.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),T+=x[g],e+=a[g]&&!m.isNavigator?a[g].margin:0;else x.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
0));M.push(x);if(d&&0<d.length)for(A=[],g=V=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(n-l),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),A.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),V+=A[g],W+=d[g]&&!m.isNavigator?d[g].margin:0;else A.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));N.push(A);if(a&&0<a.length)for(g=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(z)||s(E)||m.isNavigator||m.stockChart)||(h=0,0<a[g].labelAngle?E+u>n&&(h+=0<a[g].labelAngle?E+u-n-$:0):0>a[g].labelAngle?z-v<l&&z-v<a[g].viewportMinimum&&(F=l-(L+a[g].tickLength+y+z-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+u>n&&(h=E+u/2-n-$),z-v<l&&z-v<a[g].viewportMinimum&&(F=l-L-a[g].tickLength-y-z+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
...
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+x[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:n,y2:k-(T+e-x[g]-G),width:n-l,height:k-h}),G+=x[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+O+L),d[g].lineCoordinates.x2=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),m.panEnabled?V=s(m.sessionVariables.axisX2.height)?m.sessionVariables.axisX2.height=V:m.sessionVariables.axisX2.height:m.sessionVariables.axisX2.height=V,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+V+W-S,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-A[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(V+
W-A[g]-S),x2:n,y2:k,width:n-l,height:k-h},S+=A[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)L=m.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+V+W<Math.max(L,p)?Math.max(L,p):f.y1+V+W),n=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),L=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-T-e-L),c[g].lineCoordinates={x1:l-U,y1:h,x2:n-U,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(y[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(y[g]+U),y1:h,x2:n,y2:k,width:n-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),U+=y[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),n=Math.round(l),L=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+V+W<Math.max(L,p)?Math.max(L,p):f.y1+V+W),L=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(T+e+L)),b[g].lineCoordinates=
...
0));N.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+X+e),n=Math.round(f.x2-T-W>m.width-10?m.width-10:f.x2-T-W),c[g].labelAutoFit&&!s(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(n=0<c[g].labelAngle?n-A/2:0===c[g].labelAngle?n-A/2:n)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=n,c[g].lineCoordinates.width=Math.abs(n-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+X+e),n=Math.round(f.x2-T-W>b[g].chart.width-10?b[g].chart.width-10:f.x2-T-W),b[g]&&b[g].labelAutoFit&&!s(y)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,y):0===b[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(n-=D/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=n,b[g].lineCoordinates.width=Math.abs(n-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
...
b[0].createLabelsAndCalculateHeight():0));u.push(z);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(k=c[g]._labels[0],h=c[g]._labels[c[g]._labels.length-1],x=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),A=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));
...
2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(L,10)?Math.max(L,10):f.y1):f.y1<Math.max(L,10)?Math.max(L,10):f.y1;n=Math.round(f.x1+X+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2-U):f.y2>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2;if(c&&0<c.length)for(L=0;L<c.length;L++)c[L]&&c[L].labelAutoFit&&(n=0>c[L].labelAngle?Math.max(n,x):0===c[L].labelAngle?Math.max(n,x/2):n,l=
...
Math.max(L,10)?Math.max(L,10):f.y1):f.y1<Math.max(L,10)?Math.max(L,10):f.y1;n=Math.round(f.x2-T-W);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-U>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2-U):f.y2>m.height-Math.max(L,10)?m.height-Math.max(L,10):f.y2;if(c&&0<c.length)for(L=0;L<c.length;L++)c[L]&&c[L].labelAutoFit&&(n=0>c[L].labelAngle?Math.max(n,x):0===c[L].labelAngle?Math.max(n,x/2):n,l=0>c[L].labelAngle||0===c[L].labelAngle?n-T:l);if(b&&0<b.length)for(L=0;L<b.length;L++)b[L]&&
...
0<a.getSeconds()||0<a.getMilliseconds())a.setMonth(a.getMonth()+1),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0)}else"year"===this.intervalType&&(0<a.getMonth()||1<a.getDate()||0<a.getHours()||0<a.getMinutes()||0<a.getSeconds()||0<a.getMilliseconds())&&(a.setFullYear(a.getFullYear()+1),a.setMonth(0),a.setDate(1),a.setHours(0),a.setMinutes(0),a.setSeconds(0),a.setMilliseconds(0));return a};oa(T,U);oa(ca,U);ca.prototype.createUserOptions=function(a){if("undefined"!==
...
u<v&&(v=u,y=r);else u=Math.abs(a-this.parent.convertValueToPixel(m[r].dataPoint.y)),u<v&&(v=u,y=r);x=m[y];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[y].type||"error"===this.parent.dataSeries[y].type){v=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(r=u=0;r<x.dataPoint.y.length;r++)u=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[r])),u<v&&(v=u,b=r);n=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<
...
this.parent.convertValueToPixel(A)),u<v&&(v=u,b=r);n=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:this.parent.convertValueToPixel(A)<<0;this.value=A;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[y].type){v=Math.abs(a-this.parent.convertValueToPixel(m[0].dataPoint.y));
C=A=u=0;for(r=y;0<=r;r--)A+=m[r].dataPoint.y,C=m[r].dataPoint.x.getTime?m[r].dataPoint.x.getTime():m[r].dataPoint.x,C=100*(A/m[r].dataSeries.plotUnit.dataPointYSums[C]),u=Math.abs(a-this.parent.convertValueToPixel(C)),u<v&&(v=u,b=r);n=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;this.value=C;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:C}):s(this.options.label)?ea(c?c:C,
this.valueFormatString,this.chart._cultureInfo):this.label}else n=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):s(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=n;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;
...
h=w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,y=0;y<this.parent.dataSeries.length;y++)(v=
...
m.push(v));if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});x=m[0];b=e=n=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};C=!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=
...
!1;if(this.parent.labels)for(m=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=m)if(this.parent.labels[r])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,y=0;y<this.parent.dataSeries.length;y++)(v=this.parent.dataSeries[y].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):
s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):s(this.options.label)?Aa(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
...
value:c?c:this.parent.convertPixelToValue(a)}):s(this.options.label)?Aa(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):s(this.options.label)?ea(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):
...
this._textBlock=k;s(c)||this.renderLabel();q.globalAlpha=g};Z.prototype.renderLabel=function(){s(this._textBlock)||(s(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};oa(W,U);W.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");this.container.setAttribute("class","canvasjs-chart-tooltip");this.container.style.position=
...
this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h,c))&&0<=k.index&&(k.dataSeries=this.chart.axisX2[v].dataSeries[b],null!==k.dataPoint.y&&n.push(k))}if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});c=n[0];for(b=0;b<n.length;b++)n[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(n[b]);n=null}else{if(k=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=k.dataPointIndex,this.currentSeriesIndex=k.dataSeries.index;else if(w)if(k=Ya(a,d,this.chart._eventManager.ghostCtx),
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return n}();y.version="v3.4.13 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
